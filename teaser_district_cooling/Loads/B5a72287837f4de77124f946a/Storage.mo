...
model Storage
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_cooling/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Storage.txt"),
    columns={2,3,4})
