...
model building
  ...
  parameter Modelica.Units.SI.Temperature T_bChiWat_nominal=285.15
  ...
  parameter Modelica.Units.SI.Temperature T_bHeaWat_nominal=308.15
    "Return heating water nominal temperature";
  parameter Modelica.Units.SI.HeatFlowRate QHea_flow_nominal[nZon]={3000, 3000, 3000, 3000, 3000} ./ facMulZon
    "Design heating heat flow rate (>=0)"
    annotation (Dialog(group="Nominal condition"));
  parameter Modelica.Units.SI.HeatFlowRate QCoo_flow_nominal[nZon]={-8750, -8750, -8750, -8750, -8750} ./ facMulZon
    "Design cooling heat flow rate (<=0)"
    annotation (Dialog(group="Nominal condition"));
  parameter String idfName="modelica://spawn_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/RefBldgSmallOfficeNew2004_v1.4_9.6_5A_USA_IL_CHICAGO-OHARE.idf"
    "Path of the IDF file";
  parameter String weaName="modelica://spawn_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_CA_San.Francisco.Intl.AP.724940_TMY3.mos"
    "Path of the mos weather file";
  parameter String epwName="modelica://spawn_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_CA_San.Francisco.Intl.AP.724940_TMY3.epw"
...
equation
  ...
  for i in 1:nZon loop
    connect(terUni[i].PFan,mulSum.u[i])
       annotation (Line(points={{-119.167,9},{-100,9},{-100,220},{220,220},{220,118.333},{258,118.333}},color={0,0,127}));
    ...
    connect(disFloHea.ports_a1[i],terUni[i].port_bHeaWat)
       annotation (Line(points={{-220,-164},{-40,-164},{-40,-0.166667},{-120,-0.166667}},color={0,127,255}));
    connect(disFloHea.ports_b1[i],terUni[i].port_aHeaWat)
       annotation (Line(points={{-240,-164},{-260,-164},{-260,-0.166667},{-140,-0.166667}},color={0,127,255}));
    connect(terUni[i].mReqChiWat_flow,disFloCoo.mReq_flow[i])
       annotation (Line(points={{-119.167,3.5},{-104,3.5},{-104,-80},{-180,-80},{-180,-224},{-161,-224}},color={0,0,127}));
    connect(terUni[i].mReqHeaWat_flow,disFloHea.mReq_flow[i])
       annotation (Line(points={{-119.167,5.33333},{-100,5.33333},{-100,-90.5},{-241,-90.5},{-241,-174}},color={0,0,127}));
    connect(terUni[i].TSetHea,minTSet[i].y)
       annotation (Line(points={{-140.833,14.5},{-160,14.5},{-160,70},{-198,70}},color={0,0,127}));
    connect(terUni[i].TSetCoo,maxTSet[i].y)
       annotation (Line(points={{-140.833,12.6667},{-164,12.6667},{-164,30},{-198,30}},color={0,0,127}));
  end for;
  ...
  connect(znCore_ZN.ports[1],terUni[1].port_aLoa)
     annotation (Line(points={{42,-119.2},{-8,-119.2},{-8,18.1667},{-120,18.1667}},color={0,127,255}));
  connect(znCore_ZN.ports[2],terUni[1].port_bLoa)
     annotation (Line(points={{-140,18.1667},{-20,18.1667},{-20,-119.2},{46,-119.2}},color={0,127,255}));
  connect(znCore_ZN.TAir,terUni[1].TSen)
     annotation (Line(points={{81,13.8},{80,13.8},{80,160},{-152,160},{-152,10.8333},{-140.833,10.8333}},color={0,0,127}));
