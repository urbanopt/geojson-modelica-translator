within district_heating_and_cooling_systems.Loads.abcdefghijklmnopqrstuvwx;
model TimeSeriesBuilding
  ...
  replaceable package Medium2=Buildings.Media.Air
    ...
    "Load side medium";
  parameter String filNam="modelica://district_heating_and_cooling_systems/Loads/Resources/Data/abcdefghijklmnopqrstuvwx/time_series_large_office_2013_5B.mos"
