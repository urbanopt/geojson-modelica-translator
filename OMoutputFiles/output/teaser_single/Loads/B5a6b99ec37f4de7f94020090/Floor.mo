...
model Floor
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={7.168509129855477e-06},
    CInt={1039226572.0160843},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_single/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Buildings.Controls.OBC.CDL.Interfaces.RealOutput TAir(quantity="ThermodynamicTemperature", unit="K", displayUnit="degC") //if thermalZoneFourElements.ATot > 0 or thermalZoneFourElements.VAir > 0
  "Room air temperature" annotation(Placement(transformation(extent={{100,38},{120,58}})));
