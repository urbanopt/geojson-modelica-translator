within time_series_5g.Loads.B5a6b99ec37f4de7f94020090;
model building
  ...
  extends Buildings.Experimental.DHC.Loads.Combined.BaseClasses.PartialBuildingWithETS(
    ...
    redeclare time_series_5g.Loads.B5a6b99ec37f4de7f94020090.TimeSeriesBuilding bui(
      have_hotWat=false,
  ...
  parameter String filNam="modelica://time_series_5g/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/time_series_large_office_2013_5B.mos"
  ...
  final parameter Modelica.Units.SI.HeatFlowRate QHot_flow_nominal(
    min=Modelica.Constants.eps)=bui.facMul*Buildings.Experimental.DHC.Loads.BaseClasses.getPeakLoad(
