within time_series_massflow.Loads.B5a6b99ec37f4de7f94020090;
model building
  "Time series water mass flow rates and temperatures for a building thermal
  loads generated from Energy PLus."
  extends Modelica.Icons.Example;
  package MediumW=Buildings.Media.Water;
  parameter String filNam="modelica://time_series_massflow/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/ts_mft_ets_example_data.mos";
  parameter Modelica.Units.SI.MassFlowRate mChW_flow_nominal=getPeakMassFlowRate(
  ...
  Modelica.Fluid.Interfaces.FluidPorts_a ports_aHeaWat[1](redeclare package
      Medium = MediumW)
  ...
  Modelica.Fluid.Interfaces.FluidPorts_a ports_aChiWat[1](redeclare package
      Medium = MediumW)
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bHeaWat[1](redeclare package
      Medium = MediumW)
  ...
  Modelica.Fluid.Interfaces.FluidPorts_b ports_bChiWat[1](redeclare package
      Medium = MediumW)
  ...
  Modelica.Blocks.Interfaces.RealOutput y annotation(
    Placement(visible = true, transformation(origin = {308, 146}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {416, 152}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Blocks.Interfaces.RealOutput realOutput annotation(
    Placement(visible = true, transformation(origin = {312, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {416, 152}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  ...
  connect(buiMasTem.y[2], y) annotation(
    Line(points = {{100, -10}, {96, -10}, {96, 146}, {308, 146}}, color = {0, 0, 127}));
  connect(buiMasTem.y[4], realOutput) annotation(
    Line(points = {{100, -10}, {192, -10}, {192, 110}, {312, 110}}, color = {0, 0, 127}));
  annotation (
    Diagram(
      coordinateSystem(
    ...
    Icon(
      coordinateSystem(
        ...
        preserveAspectRatio=false),
      graphics={
        Rectangle(lineColor = {0, 0, 127}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-300, -300}, {300, 300}}),
        Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{20, -188}, {300, -172}}),
        Rectangle(lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-300, -172}, {-20, -188}}),
        Rectangle(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{18, -38}, {46, -10}}),
        Text(textColor = {0, 0, 255}, extent = {{-150, -328}, {150, -368}}, textString = "%name"),
        Rectangle(lineColor = {0, 0, 255}, fillColor = {0, 0, 255}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{20, -52}, {300, -68}}),
        Rectangle(lineColor = {0, 0, 255}, fillColor = {255, 0, 0}, pattern = LinePattern.None, fillPattern = FillPattern.Solid, extent = {{-300, -68}, {-20, -52}}),
        Rectangle(lineColor = {150, 150, 150}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Sphere, extent = {{-180, 180}, {174, -220}}),
        Rectangle(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{36, 42}, {108, 114}}),
        Rectangle(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-124, 42}, {-52, 114}}),
        Rectangle(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{-126, -122}, {-54, -50}}),
        Rectangle(lineColor = {255, 255, 255}, fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, extent = {{40, -122}, {112, -50}}),
        Polygon(lineColor = {95, 95, 95}, fillColor = {95, 95, 95}, fillPattern = FillPattern.Solid, points = {{0, 264}, {-218, 164}, {220, 164}, {0, 264}}),
        Text(extent = {{-100, 20}, {100, -20}}, textString = "MFT")}),
    __Dymola_Commands(
