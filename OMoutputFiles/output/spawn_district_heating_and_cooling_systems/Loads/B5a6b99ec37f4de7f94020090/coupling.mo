    ...
    Diagram(
      ...
      graphics={
        Text(
          ...
          textString="")}),
    __Dymola_Commands(
      file="modelica://spawn_district_heating_and_cooling_systems/Loads/Resources/Scripts/B5a6b99ec37f4de7f94020090/Dymola/RunSpawnCouplingBuilding.mos"  "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    Documentation(
