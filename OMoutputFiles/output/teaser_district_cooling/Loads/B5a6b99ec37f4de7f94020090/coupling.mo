...
model coupling
  ...
  parameter String weaName="modelica://teaser_district_cooling/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://teaser_district_cooling/Loads/Resources/Scripts/B5a6b99ec37f4de7f94020090/Dymola/RunTeaserCouplingBuilding.mos"  "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    Documentation(
