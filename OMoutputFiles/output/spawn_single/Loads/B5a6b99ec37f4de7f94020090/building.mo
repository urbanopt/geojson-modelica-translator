...
model building "n-zone EnergyPlus building model based on URBANopt GeoJSON export, with distribution pumps"
  ...
  parameter Modelica.Units.SI.HeatFlowRate QCoo_flow_nominal[nZon] = {-8750, -8750, -8750, -8750, -8750}./facMulZon "Design cooling heat flow rate (<=0)" annotation(
    Dialog(group = "Nominal condition"));
  parameter String idfName = "modelica://spawn_single/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/RefBldgSmallOfficeNew2004_v1.4_9.6_5A_USA_IL_CHICAGO-OHARE.idf" "Path of the IDF file";
  parameter String weaName = "modelica://spawn_single/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_CA_San.Francisco.Intl.AP.724940_TMY3.mos" "Path of the mos weather file";
  parameter String epwName = "modelica://spawn_single/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_CA_San.Francisco.Intl.AP.724940_TMY3.epw" "Name of the epw weather file";
