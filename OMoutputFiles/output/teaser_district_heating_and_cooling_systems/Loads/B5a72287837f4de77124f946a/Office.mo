...
model Office
  ...
  thermalZoneFourElements(
    ...
    VAir=3424.7380679999997,
    hConExt=2.6999999999999997,
    hConWin=2.7,
    gWin=0.67,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={5.677934772305951e-05},
    CExt={202124993.56203496},
    hRad=5.0,
    AInt=1712.369034,
    hConInt=2.7,
    nInt=1,
    RInt={7.217286644214232e-05},
    CInt={106966315.11255462},
    RWin=0.002234958519462838,
    RExtRem=0.0037561012746012735,
    AFloor=1312.8162593999998,
    hConFloor=1.7000000000000006,
    nFloor=1,
    RFloor={1.76175664756891e-05},
    RFloorRem=0.0012047636260724085,
    CFloor={105615108.78896935},
    ARoof=1312.8162593999998,
    hConRoof=1.7000000000000006,
    nRoof=1,
    RRoof={1.81198904523443e-05},
    RRoofRem=0.001470616587667371,
    CRoof={480311008.06481683},
    ...
    nOrientations=4,
    AWin={75.29154525378061, 4.846173657882763, 4.846173657882763, 75.29154525378061},
    ATransparent={75.29154525378061, 4.846173657882763, 4.846173657882763, 75.29154525378061},
    AExt={225.8746357613418, 14.53852097364829, 14.53852097364829, 225.8746357613418}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*480.8263134699802)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*160.27543782332674)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=32820.406485)
