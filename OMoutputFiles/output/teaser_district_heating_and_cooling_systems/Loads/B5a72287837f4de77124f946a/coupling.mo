...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Scripts/B5a72287837f4de77124f946a/Dymola/RunTeaserCouplingBuilding.mos"  "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    Documentation(
