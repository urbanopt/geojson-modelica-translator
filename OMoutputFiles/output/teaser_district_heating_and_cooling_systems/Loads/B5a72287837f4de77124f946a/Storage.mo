...
model Storage
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0001892644924101984},
    CExt={60637498.06861049},
    hRad=5.0,
    AInt=513.7107102,
    hConInt=2.7,
    nInt=1,
    RInt={0.00024057622147380769},
    CInt={32089894.533766534},
    RWin=0.0074498617315427946,
    RExtRem=0.012520337582004248,
    AFloor=393.84487781999997,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={5.872522158563033e-05},
    RFloorRem=0.004015878753574695,
    CFloor={31684532.636690814},
    ARoof=393.84487781999997,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={6.039963484114767e-05},
    RRoofRem=0.00490205529222457,
    CRoof={144093302.41944504},
    ...
    nOrientations=4,
    AWin={22.587463576134184, 1.4538520973648288, 1.4538520973648288, 22.587463576134184},
    ATransparent={22.587463576134184, 1.4538520973648288, 1.4538520973648288, 22.587463576134184},
    AExt={67.76239072840255, 4.361556292094487, 4.361556292094487, 67.76239072840255}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4697634664194476, 0.030236533580552435, 0.030236533580552435, 0.4697634664194476},
    wfWin={0.46976346641944755, 0.030236533580552435, 0.030236533580552435, 0.46976346641944755},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*144.24789404099408)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*48.08263134699803)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=9846.121945500001)
