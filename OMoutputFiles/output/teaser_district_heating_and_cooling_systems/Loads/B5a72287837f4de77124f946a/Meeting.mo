...
model Meeting
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.0009021608305267789},
    CInt={8557305.209004445},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Meeting.txt"),
    columns={2,3,4})
