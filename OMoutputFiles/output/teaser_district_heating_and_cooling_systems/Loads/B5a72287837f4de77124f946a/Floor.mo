...
within teaser_district_heating_and_cooling_systems.Loads.B5a72287837f4de77124f946a;
model Floor
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=1.8936557576825386)
    "Correction factor for solar transmission"
    annotation (Placement(transformation(extent={{6,54},{26,74}})));
  Buildings.ThermalZones.ReducedOrder.RC.FourElements
  thermalZoneFourElements(
    redeclare package Medium = Buildings.Media.Air,
    VAir=1712.3690339999998,
    hConExt=2.6999999999999997,
    hConWin=2.7,
    gWin=0.67,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.00011355869544611903},
    CExt={101062496.78101748},
    hRad=5.000000000000001,
    AInt=1855.0664535,
    hConInt=2.6999999999999997,
    nInt=1,
    RInt={6.662110748505444e-05},
    CInt={115880174.70526753},
    RWin=0.004469917038925676,
    RExtRem=0.007512202549202547,
    AFloor=656.4081296999999,
    hConFloor=1.7000000000000006,
    nFloor=1,
    RFloor={3.52351329513782e-05},
    RFloorRem=0.002409527252144817,
    CFloor={52807554.39448468},
    ARoof=656.4081296999999,
    hConRoof=1.7000000000000006,
    nRoof=1,
    RRoof={3.62397809046886e-05},
    RRoofRem=0.002941233175334742,
    CRoof={240155504.03240842},
    ...
    nOrientations=4,
    AWin={37.645772626890306, 2.4230868289413814, 2.4230868289413814, 37.645772626890306},
    ATransparent={37.645772626890306, 2.4230868289413814, 2.4230868289413814, 37.645772626890306},
    AExt={112.9373178806709, 7.269260486824145, 7.269260486824145, 112.9373178806709}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4697634664194476, 0.030236533580552432, 0.030236533580552432, 0.4697634664194476},
    wfWin={0.46976346641944755, 0.030236533580552432, 0.030236533580552432, 0.46976346641944755},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*240.4131567349901)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*80.13771891166337)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=16410.2032425)
