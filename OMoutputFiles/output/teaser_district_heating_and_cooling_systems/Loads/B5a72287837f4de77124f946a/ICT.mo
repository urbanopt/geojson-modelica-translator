...
model ICT
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0014194836930764877},
    CExt={8084999.7424814},
    hRad=4.999999999999999,
    AInt=68.49476136,
    hConInt=2.6999999999999997,
    nInt=1,
    RInt={0.0018043216610535578},
    CInt={4278652.6045022225},
    RWin=0.05587396298657097,
    RExtRem=0.09390253186503188,
    AFloor=52.51265037599999,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0004404391618922276},
    RFloorRem=0.030119090651810218,
    CFloor={4224604.351558751},
    ARoof=52.51265037599999,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00045299726130860763},
    RRoofRem=0.036765414691684276,
    CRoof={19212440.322592676},
    ...
    nOrientations=4,
    AWin={3.0116618101512245, 0.1938469463153105, 0.1938469463153105, 3.0116618101512245},
    ATransparent={3.0116618101512245, 0.1938469463153105, 0.1938469463153105, 3.0116618101512245},
    AExt={9.034985430453672, 0.5815408389459316, 0.5815408389459316, 9.034985430453672}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*19.233052538799203)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*6.4110175129330695)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1312.8162593999998)
