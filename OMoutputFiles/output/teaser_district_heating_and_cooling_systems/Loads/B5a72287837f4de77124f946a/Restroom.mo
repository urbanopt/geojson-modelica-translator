...
model Restroom
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0007097418465382439},
    CExt={16169999.4849628},
    hRad=4.999999999999999,
    AInt=228.3158712,
    hConInt=2.7,
    nInt=1,
    RInt={0.0005412964983160673},
    CInt={14262175.348340746},
    RWin=0.027936981493285485,
    RExtRem=0.04695126593251594,
    AFloor=105.02530075199998,
    hConFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0002202195809461138},
    RFloorRem=0.015059545325905109,
    CFloor={8449208.703117503},
    ARoof=105.02530075199998,
    hConRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00022649863065430382},
    RRoofRem=0.018382707345842138,
    CRoof={38424880.64518535},
    ...
    nOrientations=4,
    AWin={6.023323620302449, 0.387693892630621, 0.387693892630621, 6.023323620302449},
    ATransparent={6.023323620302449, 0.387693892630621, 0.387693892630621, 6.023323620302449},
    AExt={18.069970860907343, 1.1630816778918631, 1.1630816778918631, 18.069970860907343}, nPorts=nPorts, use_moisture_balance=use_moisture_balance)
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.46976346641944755, 0.030236533580552442, 0.030236533580552442, 0.46976346641944755},
    wfWin={0.4697634664194476, 0.030236533580552432, 0.030236533580552432, 0.4697634664194476},
    withLongwave=true,
    aExt=0.5,
    hConWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*38.46610507759841)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*12.822035025866139)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=2625.6325187999996)
