...
model building
  ...
  parameter String weaName="modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a72287837f4de77124f946a/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"
...
equation
  ...
  connect(terUni[0+1].heaPorCon,office.port_a)
     annotation (Line(points={{-193.333,-50},{-192,-50},{-192,0},{-90,0}},color={191,0,0}));
  connect(terUni[0+1].heaPorRad,office.port_a)
  ...
  connect(weaDat.weaBus,floor.weaBus)
    annotation (Line(points={{1,300},{0,300},{0,20},{-66,20},{-66,-10.2},{-96,-10.2}},color={255,204,51},thickness=0.5),Text(string="%first",index=-1,extent={{6,3},{6,3}},horizontalAlignment=TextAlignment.Left));
  connect(terUni[3+1].heaPorCon,floor.port_a)
     annotation (Line(points={{-193.333,-50},{-192,-50},{-192,0},{-90,0}},color={191,0,0}));
  connect(terUni[3+1].heaPorRad,floor.port_a)
     annotation (Line(points={{-186.667,-50},{-90,-50},{-90,0}},color={191,0,0}));
