...
model Office
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_Office.txt"),
    columns={2,3,4})
