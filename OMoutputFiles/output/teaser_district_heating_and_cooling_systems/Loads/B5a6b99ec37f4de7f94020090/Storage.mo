...
model Storage
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={1.8701408240708148e-05},
    CInt={407243619.07755303},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_Storage.txt"),
    columns={2,3,4})
