...
model Restroom
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={5.301308905050736e-05},
    CInt={141556948.13576502},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    tableName="Internals",
    fileName=Modelica.Utilities.Files.loadResource("modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/InternalGains_Restroom.txt"),
    columns={2,3,4})
