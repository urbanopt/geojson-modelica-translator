within teaser_district_heating_and_cooling_systems.Loads.B5a6b99ec37f4de7f94020090;
model coupling
  "Example illustrating the coupling of TEASER building loads with infinite heating and cooling sources with no ETS"
  extends Modelica.Icons.Example;
  parameter String weaName="modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Data/B5a6b99ec37f4de7f94020090/USA_IL_Chicago-OHare.Intl.AP.725300_TMY3.mos"
...
equation
  ...
  annotation (
    ...
    __Dymola_Commands(
      file="modelica://teaser_district_heating_and_cooling_systems/Loads/Resources/Scripts/B5a6b99ec37f4de7f94020090/Dymola/RunTeaserCouplingBuilding.mos"  "Simulate and plot"),
    experiment(
      StopTime=604800,
      Tolerance=1e-06),
    Documentation(
