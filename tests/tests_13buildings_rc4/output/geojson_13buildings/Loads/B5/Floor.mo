...
model Floor
  "This is the simulation model of Floor within building B5 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.000300912884088687},
    CExt={37619026.68420736},
    hRad=5.0,
    AInt=2659.1777680000005,
    hConvInt=2.7,
    nInt=1,
    RInt={4.647548692598068e-05},
    CInt={166110482.85996354},
    RWin=0.0054673938830636214,
    RExtRem=0.012350029073111305,
    AFloor=235.23495640000002,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={0.00011130299629193411},
    RFloorRem=0.0035021055421679556,
    CFloor={20951344.94689738},
    ARoof=235.23495640000002,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={9.943166556576476e-05},
    RRoofRem=0.004938963576981976,
    CRoof={85345061.56945899},
    ...
    nOrientations=4,
    AWin={12.657442547863454, 2.2733736338823785, 12.657442547863454, 2.2733736338823785},
    ATransparent={12.657442547863454, 2.2733736338823785, 12.657442547863454, 2.2733736338823785},
    AExt={37.97232764359036, 6.820120901647135, 37.97232764359036, 6.820120901647135})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.42386974676368444, 0.07613025323631563, 0.42386974676368444, 0.07613025323631563},
    wfWin={0.4238697467636844, 0.07613025323631563, 0.4238697467636844, 0.07613025323631563},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*89.58489709047498)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*29.861632363491665)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B5/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=5880.873910000001)
