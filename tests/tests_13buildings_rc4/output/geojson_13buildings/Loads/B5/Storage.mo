...
model Storage
  "This is the simulation model of Storage within building B5 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.000501521473481145},
    CExt={22571416.010524403},
    hRad=5.000000000000001,
    AInt=736.3876895999999,
    hConvInt=2.7000000000000006,
    nInt=1,
    RInt={0.00016782814723270806},
    CInt={45999826.02275912},
    RWin=0.00911232313843937,
    RExtRem=0.02058338178851884,
    AFloor=141.14097384,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00018550499381989022},
    RFloorRem=0.005836842570279927,
    CFloor={12570806.968138421},
    ARoof=141.14097384,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00016571944260960797},
    RRoofRem=0.008231605961636627,
    CRoof={51207036.94167541},
    ...
    nOrientations=4,
    AWin={7.594465528718072, 1.3640241803294268, 7.594465528718072, 1.3640241803294268},
    ATransparent={7.594465528718072, 1.3640241803294268, 7.594465528718072, 1.3640241803294268},
    AExt={22.783396586154215, 4.092072540988281, 22.783396586154215, 4.092072540988281})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.42386974676368444, 0.07613025323631561, 0.42386974676368444, 0.07613025323631561},
    wfWin={0.42386974676368444, 0.07613025323631561, 0.42386974676368444, 0.07613025323631561},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*53.75093825428499)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*17.916979418094996)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B5/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=3528.524346)
