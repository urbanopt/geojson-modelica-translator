...
model Office
  "This is the simulation model of Office within building B5 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0001504564420443435},
    CExt={75238053.36841471},
    hRad=4.999999999999999,
    AInt=2454.625632,
    hConvInt=2.7,
    nInt=1,
    RInt={5.034844416981241e-05},
    CInt={153332753.4091971},
    RWin=0.0027336969415318107,
    RExtRem=0.006175014536555653,
    AFloor=470.46991280000003,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={5.5651498145967055e-05},
    RFloorRem=0.0017510527710839778,
    CFloor={41902689.89379476},
    ARoof=470.46991280000003,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={4.971583278288238e-05},
    RRoofRem=0.002469481788490988,
    CRoof={170690123.13891798},
    ...
    nOrientations=4,
    AWin={25.314885095726908, 4.546747267764757, 25.314885095726908, 4.546747267764757},
    ATransparent={25.314885095726908, 4.546747267764757, 25.314885095726908, 4.546747267764757},
    AExt={75.94465528718072, 13.64024180329427, 75.94465528718072, 13.64024180329427})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*179.16979418094996)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*59.72326472698333)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B5/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=11761.747820000002)
