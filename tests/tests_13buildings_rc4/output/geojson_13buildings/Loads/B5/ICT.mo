...
model ICT
  "This is the simulation model of ICT within building B5 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=196.37005056000004,
    hConvExt=2.6999999999999997,
    hConvWin=2.6999999999999997,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0037614110511085875},
    CExt={3009522.1347365878},
    hRad=5.0,
    AInt=98.18502528000002,
    hConvInt=2.7,
    nInt=1,
    RInt={0.0012587111042453103},
    CInt={6133310.136367909},
    RWin=0.06834242353829525,
    RExtRem=0.15437536341389127,
    AFloor=18.818796512000002,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0013912874536491765},
    RFloorRem=0.04377631927709944,
    CFloor={1676107.595751803},
    ARoof=18.818796512000002,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0012428958195720595},
    RRoofRem=0.0617370447122747,
    CRoof={6827604.925556722},
    ...
    nOrientations=4,
    AWin={1.0125954038290765, 0.1818698907105903, 1.0125954038290765, 0.1818698907105903},
    ATransparent={1.0125954038290765, 0.1818698907105903, 1.0125954038290765, 0.1818698907105903},
    AExt={3.037786211487229, 0.5456096721317709, 3.037786211487229, 0.5456096721317709})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*7.166791767238001)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*2.388930589079334)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B5/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=470.46991280000003)
