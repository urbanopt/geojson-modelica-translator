within geojson_13buildings.Loads.B9;
model Storage
  "This is the simulation model of Storage within building B9 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={7.324668490533088e-05},
    CInt={95555014.30352172},
    RWin=0.007564124439079505,
    RExtRem=0.017086231344085618,
    AFloor=57.12009198,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00045837383261024793},
    RFloorRem=0.014422554585670638,
    CFloor={5087435.850463108},
    ARoof=57.12009198,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00040948469624894424},
    RRoofRem=0.02033989864896123,
    CRoof={20723611.156654876},
    ...
    nOrientations=4,
    AWin={7.4747671030155765, 3.317315142415932, 7.4747671030155765, 3.317315142415932},
    ATransparent={7.4747671030155765, 3.317315142415932, 7.4747671030155765, 3.317315142415932},
    AExt={22.424301309046726, 9.951945427247795, 22.424301309046726, 9.951945427247795})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.34630791968712926, 0.15369208031287077, 0.34630791968712926, 0.15369208031287077},
    wfWin={0.34630791968712926, 0.15369208031287077, 0.34630791968712926, 0.15369208031287077},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
    hConvWinOut=20.000000000000004,
  ...
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*64.75249347258904)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*21.584164490863017)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1428.0022995000002)
