...
model Office
  "This is the simulation model of Office within building B9 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.0017821341055924)
  ...
  thermalZoneFourElements(
    ...
    AInt=3642.4406480000002,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={2.197400547159926e-05},
    CInt={318516714.3450724},
    RWin=0.0022692373317238514,
    RExtRem=0.005125869403225684,
    AFloor=190.4003066,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={0.00013751214978307438},
    RFloorRem=0.004326766375701191,
    CFloor={16958119.501543693},
    ARoof=190.4003066,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={0.00012284540887468328},
    RRoofRem=0.006101969594688369,
    CRoof={69078703.85551628},
    ...
    nOrientations=4,
    AWin={24.915890343385254, 11.05771714138644, 24.915890343385254, 11.05771714138644},
    ATransparent={24.915890343385254, 11.05771714138644, 24.915890343385254, 11.05771714138644},
    AExt={74.74767103015576, 33.17315142415932, 74.74767103015576, 33.17315142415932})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.3463079196871292, 0.15369208031287074, 0.3463079196871292, 0.15369208031287074},
    wfWin={0.3463079196871292, 0.15369208031287074, 0.3463079196871292, 0.15369208031287074},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*215.84164490863017)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=4760.007665000001)
