...
model Restroom
  "This is the simulation model of Restroom within building B9 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.0002029884347104051},
    CInt={34660120.58654568},
    RWin=0.02836546664654814,
    RExtRem=0.06407336754032107,
    AFloor=15.232024528,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00171890187228843},
    RFloorRem=0.05408457969626489,
    CFloor={1356649.5601234848},
    ARoof=15.232024528,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0015355676109335412},
    RRoofRem=0.07627461993360463,
    CRoof={5526296.308441299},
    ...
    nOrientations=4,
    AWin={1.9932712274708204, 0.8846173713109153, 1.9932712274708204, 0.8846173713109153},
    ATransparent={1.9932712274708204, 0.8846173713109153, 1.9932712274708204, 0.8846173713109153},
    AExt={5.97981368241246, 2.6538521139327456, 5.97981368241246, 2.6538521139327456})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.34630791968712915, 0.1536920803128708, 0.34630791968712915, 0.1536920803128708},
    wfWin={0.34630791968712926, 0.1536920803128708, 0.34630791968712926, 0.1536920803128708},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*17.26733159269041)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=380.80061320000004)
