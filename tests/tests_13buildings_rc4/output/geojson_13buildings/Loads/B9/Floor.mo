...
model Floor
  "This is the simulation model of Floor within building B9 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=3559.6579060000004,
    hConvInt=2.6069767441860465,
    nInt=1,
    RInt={2.7161052798995214e-05},
    CInt={259651349.72309482},
    RWin=0.004538474663447703,
    RExtRem=0.010251738806451367,
    AFloor=95.2001533,
    ...
    nOrientations=4,
    AWin={12.457945171692627, 5.52885857069322, 12.457945171692627, 5.52885857069322},
    ATransparent={12.457945171692627, 5.52885857069322, 12.457945171692627, 5.52885857069322},
    AExt={37.37383551507788, 16.58657571207966, 37.37383551507788, 16.58657571207966})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*107.92082245431509)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_Floor.txt"),
    columns={2,3,4})
