...
model ICT
  "This is the simulation model of ICT within building B9 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.0005493501367899815},
    CInt={12740668.573802892},
    RWin=0.05673093329309628,
    ...
    nOrientations=4,
    AWin={0.9966356137354102, 0.44230868565545767, 0.9966356137354102, 0.44230868565545767},
    ATransparent={0.9966356137354102, 0.44230868565545767, 0.9966356137354102, 0.44230868565545767},
    AExt={2.98990684120623, 1.3269260569663728, 2.98990684120623, 1.3269260569663728})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*8.633665796345205)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*2.8778885987817358)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_ICT.txt"),
    columns={2,3,4})
