...
model Meeting
  "This is the simulation model of Meeting within building B9 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={0.00027467506839499073},
    CInt={25481337.147605784},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B9/InternalGains_Meeting.txt"),
    columns={2,3,4})
