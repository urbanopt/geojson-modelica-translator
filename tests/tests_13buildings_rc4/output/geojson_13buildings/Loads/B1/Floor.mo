within geojson_13buildings.Loads.B1;
model Floor
  "This is the simulation model of Floor within building B1 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.001782134105591)
  ...
  thermalZoneFourElements(
    ...
    VAir=209714.916672,
    hConvExt=2.6999999999999997,
    hConvWin=2.6999999999999997,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={3.991068766317606e-06},
    CExt={2836345470.0878663},
    hRad=4.999999999999999,
    AInt=250492.81713599997,
    hConvInt=2.6069767441860465,
    nInt=1,
    RInt={3.8597536423064017e-07},
    CInt={18271642888.962143},
    RWin=7.251515675686387e-05,
    RExtRem=0.0001638009467294258,
    AFloor=6699.226504799999,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={3.908265448430922e-06},
    RFloorRem=0.00012297205415129817,
    CFloor={596670696.9384012},
    ARoof=6699.226504799999,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={3.4914185238226017e-06},
    RRoofRem=0.00017342552619471828,
    CRoof={2430531190.048538},
    ...
    nOrientations=4,
    AWin={1118.6771252298704, 7.055159055615938, 1118.6771252298704, 7.055159055615938},
    ATransparent={1118.6771252298704, 7.055159055615938, 1118.6771252298704, 7.055159055615938},
    AExt={3356.0313756896107, 21.16547716684781, 3356.0313756896107, 21.16547716684781})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4968664134652166, 0.0031335865347834092, 0.4968664134652166, 0.0031335865347834092},
    wfWin={0.4968664134652166, 0.0031335865347834097, 0.4968664134652166, 0.0031335865347834097},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=19.99999999999999,
    hRad=4.999999999999999,
    hConvWinOut=19.999999999999993,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.99999999999999*6754.393705712918)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.99999999999999*2251.464568570973)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B1/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=167480.66262)
...
equation
  ...
  connect(eqAirTempVDI.HSol, solRadRoof.y) annotation (Line(points={{28,50},
      ...
      index=1,
      extent={{6,3},{6,3}}));
  connect(port_a, thermalZoneFourElements.intGainsConv)
