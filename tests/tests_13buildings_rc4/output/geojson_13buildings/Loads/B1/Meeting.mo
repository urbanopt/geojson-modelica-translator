...
model Meeting
  "This is the simulation model of Meeting within building B1 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={2.4944179789485048e-05},
    CExt={453815275.21405834},
    hRad=5.0,
    AInt=20505.458519039996,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={3.903302657426983e-06},
    CInt={1793119478.0648057},
    RWin=0.00045321972973039925,
    RExtRem=0.0010237559170589113,
    AFloor=1071.876240768,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={2.4426659052693258e-05},
    RFloorRem=0.0007685753384456135,
    CFloor={95467311.51014493},
    ARoof=1071.876240768,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={2.1821365773891258e-05},
    RRoofRem=0.0010839095387169893,
    CRoof={388884990.407766},
    ...
    nOrientations=4,
    AWin={178.98834003677925, 1.12882544889855, 178.98834003677925, 1.12882544889855},
    ATransparent={178.98834003677925, 1.12882544889855, 178.98834003677925, 1.12882544889855},
    AExt={536.9650201103376, 3.3864763466956496, 536.9650201103376, 3.3864763466956496})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4968664134652166, 0.00313358653478341, 0.4968664134652166, 0.00313358653478341},
    wfWin={0.49686641346521654, 0.0031335865347834097, 0.49686641346521654, 0.0031335865347834097},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*1080.7029929140665)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*360.23433097135563)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B1/InternalGains_Meeting.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=26796.9060192)
