...
model Storage
  "This is the simulation model of Storage within building B1 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={6.65178127719601e-06},
    CExt={1701807282.0527196},
    hRad=5.000000000000001,
    AInt=76895.46944639999,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={1.0408807086471952e-06},
    CInt={6724198042.743023},
    RWin=0.0001208585945947731,
    RExtRem=0.0002730015778823762,
    AFloor=4019.53590288,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={6.51377574738487e-06},
    RFloorRem=0.0002049534235854969,
    CFloor={358002418.1630407},
    ARoof=4019.53590288,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={5.819030873037669e-06},
    RRoofRem=0.0002890425436578638,
    CRoof={1458318714.0291224},
    ...
    nOrientations=4,
    AWin={671.2062751379223, 4.233095433369563, 671.2062751379223, 4.233095433369563},
    ATransparent={671.2062751379223, 4.233095433369563, 671.2062751379223, 4.233095433369563},
    AExt={2013.6188254137664, 12.699286300108687, 2013.6188254137664, 12.699286300108687})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.49686641346521654, 0.003133586534783409, 0.49686641346521654, 0.003133586534783409},
    wfWin={0.4968664134652166, 0.00313358653478341, 0.4968664134652166, 0.00313358653478341},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*4052.6362234277503)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*1350.8787411425835)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B1/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=100488.39757200002)
