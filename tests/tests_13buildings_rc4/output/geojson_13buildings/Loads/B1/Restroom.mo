...
model Restroom
  "This is the simulation model of Restroom within building B1 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=31690.25407488,
    hConvInt=2.582352941176471,
    nInt=1,
    RInt={2.8845912417965813e-06},
    CInt={2439029670.059901},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B1/InternalGains_Restroom.txt"),
    columns={2,3,4})
