...
model ICT
  "This is the simulation model of ICT within building B1 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.9888359578970095e-05},
    CExt={226907637.60702917},
    hRad=5.0,
    AInt=10252.729259519998,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={7.806605314853965e-06},
    CInt={896559739.0324029},
    RWin=0.0009064394594607985,
    RExtRem=0.0020475118341178227,
    AFloor=535.938120384,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={4.8853318105386516e-05},
    RFloorRem=0.001537150676891227,
    CFloor={47733655.75507247},
    ARoof=535.938120384,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={4.3642731547782515e-05},
    RRoofRem=0.0021678190774339786,
    CRoof={194442495.203883},
    ...
    nOrientations=4,
    AWin={89.49417001838962, 0.564412724449275, 89.49417001838962, 0.564412724449275},
    ATransparent={89.49417001838962, 0.564412724449275, 89.49417001838962, 0.564412724449275},
    AExt={268.4825100551688, 1.6932381733478248, 268.4825100551688, 1.6932381733478248})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*540.3514964570332)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*180.11716548567782)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B1/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=13398.4530096)
