...
model Floor
  "This is the simulation model of Floor within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={8.787400494749773e-05},
    CExt={128821371.26807329},
    hRad=5.000000000000001,
    AInt=10531.112541999999,
    hConvInt=2.6069767441860465,
    nInt=1,
    RInt={9.180801738243046e-06},
    CInt={768168643.6798042},
    RWin=0.0015966142446351762,
    RExtRem=0.003606513955555562,
    AFloor=281.6460331,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={9.296191816281075e-05},
    RFloorRem=0.0029250106435107373,
    CFloor={25084975.81613417},
    ARoof=281.6460331,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={8.304680615131326e-05},
    RRoofRem=0.004125095847808493,
    CRoof={102183359.15534607},
    ...
    nOrientations=4,
    AWin={44.45922841875255, 6.669372829495378, 44.45922841875255, 6.669372829495378},
    ATransparent={44.45922841875255, 6.669372829495378, 44.45922841875255, 6.669372829495378},
    AExt={133.37768525625765, 20.008118488486133, 133.37768525625765, 20.008118488486133})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4347784540680748, 0.06522154593192517, 0.4347784540680748, 0.06522154593192517},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*306.77160748948756)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*102.25720249649585)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=7041.1508275000015)
