...
model Storage
  "This is the simulation model of Storage within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=5290.0472303999995,
    hConvExt=2.6999999999999997,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.00014645667491249625},
    CExt={77292822.76084392},
    hRad=5.0,
    AInt=3232.8066407999995,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={2.4758366219304996e-05},
    CInt={282695875.8836436},
    RWin=0.0026610237410586274,
    RExtRem=0.006010856592592605,
    AFloor=168.98761985999997,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00015493653027135127},
    RFloorRem=0.004875017739184563,
    CFloor={15050985.489680499},
    ARoof=168.98761985999997,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00013841134358552213},
    RRoofRem=0.0068751597463474895,
    CRoof={61310015.49320765},
    ...
    nOrientations=4,
    AWin={26.675537051251528, 4.001623697697227, 26.675537051251528, 4.001623697697227},
    ATransparent={26.675537051251528, 4.001623697697227, 26.675537051251528, 4.001623697697227},
    AExt={80.02661115375457, 12.004871093091678, 80.02661115375457, 12.004871093091678})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4347784540680748, 0.06522154593192518, 0.4347784540680748, 0.06522154593192518},
    wfWin={0.43477845406807486, 0.06522154593192517, 0.43477845406807486, 0.06522154593192517},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*184.0629644936925)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*61.35432149789751)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=4224.6904965)
