...
model Office
  "This is the simulation model of Office within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={4.393700247374886e-05},
    CExt={257642742.53614658},
    hRad=4.999999999999999,
    AInt=10776.022136000001,
    hConvInt=2.5181818181818176,
    nInt=1,
    RInt={7.427509865791497e-06},
    CInt={942319586.278812},
    RWin=0.0007983071223175881,
    RExtRem=0.001803256977777781,
    AFloor=563.2920662,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={4.6480959081405374e-05},
    RFloorRem=0.0014625053217553687,
    CFloor={50169951.63226834},
    ARoof=563.2920662,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={4.152340307565663e-05},
    RRoofRem=0.0020625479239042466,
    CRoof={204366718.31069213},
    ...
    nOrientations=4,
    AWin={88.9184568375051, 13.338745658990756, 88.9184568375051, 13.338745658990756},
    ATransparent={88.9184568375051, 13.338745658990756, 88.9184568375051, 13.338745658990756},
    AExt={266.7553705125153, 40.016236976972266, 266.7553705125153, 40.016236976972266})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*613.5432149789751)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*204.5144049929917)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=14082.301655000003)
