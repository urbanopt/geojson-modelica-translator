within geojson_13buildings.Loads.B4;
model Meeting
  "This is the simulation model of Meeting within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=1410.6792614400001,
    hConvExt=2.7000000000000006,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.000549212530921861},
    CExt={20611419.40289171},
    hRad=4.999999999999999,
    AInt=862.0817708799999,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={9.284387332239375e-05},
    CInt={75385566.90230495},
    RWin=0.009978839028969852,
    RExtRem=0.022540712222222262,
    AFloor=45.06336529599999,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0005810119885175673},
    RFloorRem=0.018281316521942113,
    CFloor={4013596.130581435},
    ARoof=45.06336529599999,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.000519042538445708},
    RRoofRem=0.02578184904880308,
    CRoof={16349337.464855384},
    ...
    nOrientations=4,
    AWin={7.113476547000408, 1.0670996527192604, 7.113476547000408, 1.0670996527192604},
    ATransparent={7.113476547000408, 1.0670996527192604, 7.113476547000408, 1.0670996527192604},
    AExt={21.340429641001222, 3.201298958157781, 21.340429641001222, 3.201298958157781})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.43477845406807486, 0.06522154593192517, 0.43477845406807486, 0.06522154593192517},
    wfWin={0.4347784540680748, 0.06522154593192518, 0.4347784540680748, 0.06522154593192518},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*49.083457198318)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*16.361152399439337)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_Meeting.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1126.5841324)
