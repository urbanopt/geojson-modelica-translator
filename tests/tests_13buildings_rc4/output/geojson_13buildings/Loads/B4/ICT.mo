...
model ICT
  "This is the simulation model of ICT within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=705.3396307200001,
    hConvExt=2.7000000000000006,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.001098425061843722},
    CExt={10305709.701445855},
    hRad=4.999999999999999,
    AInt=431.04088543999995,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={0.0001856877466447875},
    CInt={37692783.45115247},
    RWin=0.019957678057939705,
    RExtRem=0.045081424444444525,
    AFloor=22.531682647999997,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0011620239770351345},
    RFloorRem=0.03656263304388423,
    CFloor={2006798.0652907174},
    ARoof=22.531682647999997,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.001038085076891416},
    RRoofRem=0.05156369809760616,
    CRoof={8174668.732427692},
    ...
    nOrientations=4,
    AWin={3.556738273500204, 0.5335498263596302, 3.556738273500204, 0.5335498263596302},
    ATransparent={3.556738273500204, 0.5335498263596302, 3.556738273500204, 0.5335498263596302},
    AExt={10.670214820500611, 1.6006494790788905, 10.670214820500611, 1.6006494790788905})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*24.541728599159)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*8.180576199719669)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=563.2920662)
