...
model Restroom
  "This is the simulation model of Restroom within building B4 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=1332.30819136,
    hConvInt=2.5823529411764707,
    nInt=1,
    RInt={6.861282543147455e-05},
    CInt={102540648.63956727},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B4/InternalGains_Restroom.txt"),
    columns={2,3,4})
