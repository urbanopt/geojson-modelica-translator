...
model Storage
  "This is the simulation model of Storage within building B11 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=5438.5961328,
    hConvExt=2.7000000000000015,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0001425898799928479},
    CExt={79388872.59545986},
    hRad=4.999999999999999,
    AInt=3323.5865256,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={2.4082120357819862e-05},
    CInt={290634209.9374866},
    RWin=0.0025907665602975818,
    RExtRem=0.0058521560775846105,
    AFloor=173.73293202000002,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0001507046198754557},
    RFloorRem=0.004741862322482649,
    CFloor={15473629.61309815},
    ARoof=173.73293202000002,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.000134630799366521},
    RRoofRem=0.006687372786402957,
    CRoof={63031651.44672156},
    ...
    nOrientations=4,
    AWin={27.49690095439122, 4.012172194927177, 27.49690095439122, 4.012172194927177},
    ATransparent={27.49690095439122, 4.012172194927177, 27.49690095439122, 4.012172194927177},
    AExt={82.49070286317365, 12.036516584781529, 82.49070286317365, 12.036516584781529})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*189.05443889591035)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*63.01814629863679)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=4343.323300500001)
