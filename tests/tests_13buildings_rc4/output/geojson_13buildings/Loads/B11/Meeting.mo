...
model Meeting
  "This is the simulation model of Meeting within building B11 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=1450.2923020800001,
    hConvExt=2.7,
    hConvWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0005347120499731799},
    CExt={21170366.02545595},
    hRad=4.999999999999999,
    AInt=886.2897401600001,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={9.030795134182449e-05},
    CInt={77502455.98332974},
    RWin=0.009715374601115928,
    RExtRem=0.02194558529094229,
    AFloor=46.32878187200001,
    hConvFloor=1.7,
    nFloor=1,
    RFloor={0.0005651423245329588},
    RFloorRem=0.017781983709309935,
    CFloor={4126301.230159506},
    ARoof=46.32878187200001,
    hConvRoof=1.7,
    nRoof=1,
    RRoof={0.0005048654976244539},
    RRoofRem=0.025077647949011097,
    CRoof={16808440.385792412},
    ...
    nOrientations=4,
    AWin={7.332506921170992, 1.069912585313914, 7.332506921170992, 1.069912585313914},
    ATransparent={7.332506921170992, 1.069912585313914, 7.332506921170992, 1.069912585313914},
    AExt={21.997520763512973, 3.2097377559417413, 21.997520763512973, 3.2097377559417413})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.4363330654647649, 0.06366693453523511, 0.4363330654647649, 0.06366693453523511},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*50.41451703890943)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*16.80483901296981)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_Meeting.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1158.2195468000004)
