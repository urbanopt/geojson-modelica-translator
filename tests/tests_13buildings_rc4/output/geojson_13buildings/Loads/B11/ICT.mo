...
model ICT
  "This is the simulation model of ICT within building B11 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=725.1461510400001,
    hConvExt=2.7,
    hConvWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0010694240999463598},
    CExt={10585183.012727976},
    hRad=4.999999999999999,
    AInt=443.14487008000003,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={0.00018061590268364898},
    CInt={38751227.99166487},
    RWin=0.019430749202231857,
    RExtRem=0.04389117058188458,
    AFloor=23.164390936000004,
    hConvFloor=1.7,
    nFloor=1,
    RFloor={0.0011302846490659176},
    RFloorRem=0.03556396741861987,
    CFloor={2063150.615079753},
    ARoof=23.164390936000004,
    hConvRoof=1.7,
    nRoof=1,
    RRoof={0.0010097309952489077},
    RRoofRem=0.050155295898022194,
    CRoof={8404220.192896206},
    ...
    nOrientations=4,
    AWin={3.666253460585496, 0.534956292656957, 3.666253460585496, 0.534956292656957},
    ATransparent={3.666253460585496, 0.534956292656957, 3.666253460585496, 0.534956292656957},
    AExt={10.998760381756487, 1.6048688779708706, 10.998760381756487, 1.6048688779708706})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*25.207258519454715)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*8.402419506484906)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=579.1097734000002)
