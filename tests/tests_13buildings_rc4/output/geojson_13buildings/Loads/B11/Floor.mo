...
model Floor
  "This is the simulation model of Floor within building B11 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={8.555392799570879e-05},
    CExt={132314787.6590997},
    hRad=4.999999999999999,
    AInt=10826.834894000003,
    hConvInt=2.6069767441860465,
    nInt=1,
    RInt={8.930038859723164e-06},
    CInt={789739454.6587648},
    RWin=0.0015544599361785488,
    RExtRem=0.0035112936465507673,
    AFloor=289.55488670000005,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={9.04227719252734e-05},
    RFloorRem=0.0028451173934895893,
    CFloor={25789382.68849692},
    ARoof=289.55488670000005,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={8.077847961991261e-05},
    RRoofRem=0.004012423671841775,
    CRoof={105052752.4112026},
    ...
    nOrientations=4,
    AWin={45.8281682573187, 6.686953658211962, 45.8281682573187, 6.686953658211962},
    ATransparent={45.8281682573187, 6.686953658211962, 45.8281682573187, 6.686953658211962},
    AExt={137.48450477195607, 20.060860974635883, 137.48450477195607, 20.060860974635883})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*315.0907314931839)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*105.03024383106133)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=7238.872167500003)
