...
model Restroom
  "This is the simulation model of Restroom within building B11 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={6.67387462280311e-05},
    CInt={105420074.87970689},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_Restroom.txt"),
    columns={2,3,4})
