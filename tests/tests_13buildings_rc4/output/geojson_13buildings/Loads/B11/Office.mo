within geojson_13buildings.Loads.B11;
model Office
  "This is the simulation model of Office within building B11 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.0017821341055915)
  ...
  thermalZoneFourElements(
    ...
    VAir=18128.653776,
    hConvExt=2.7000000000000006,
    hConvWin=2.7000000000000006,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.277696399785439e-05},
    CExt={264629575.3181994},
    hRad=5.0,
    AInt=11078.621752000001,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={7.224636107345962e-06},
    CInt={968780699.791622},
    RWin=0.0007772299680892744,
    RExtRem=0.0017556468232753837,
    AFloor=579.1097734000001,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={4.52113859626367e-05},
    RFloorRem=0.0014225586967447947,
    CFloor={51578765.37699384},
    ARoof=579.1097734000001,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={4.0389239809956305e-05},
    RRoofRem=0.0020062118359208876,
    CRoof={210105504.8224052},
    ...
    nOrientations=4,
    AWin={91.6563365146374, 13.373907316423924, 91.6563365146374, 13.373907316423924},
    ATransparent={91.6563365146374, 13.373907316423924, 91.6563365146374, 13.373907316423924},
    AExt={274.96900954391214, 40.121721949271766, 274.96900954391214, 40.121721949271766})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4363330654647649, 0.0636669345352351, 0.4363330654647649, 0.0636669345352351},
    wfWin={0.43633306546476486, 0.0636669345352351, 0.43633306546476486, 0.0636669345352351},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*630.1814629863678)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*210.06048766212265)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B11/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=14477.744335000007)
