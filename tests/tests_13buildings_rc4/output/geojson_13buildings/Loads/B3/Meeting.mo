...
model Meeting
  "This is the simulation model of Meeting within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=3424.855167360001,
    hConvInt=2.518181818181818,
    nInt=1,
    RInt={2.337004247418277e-05},
    CInt={299489743.398902},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_Meeting.txt"),
    columns={2,3,4})
