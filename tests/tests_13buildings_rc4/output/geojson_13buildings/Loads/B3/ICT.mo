...
model ICT
  "This is the simulation model of ICT within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0002881358874217271},
    CExt={39287191.60062709},
    hRad=5.0,
    AInt=1712.4275836800005,
    hConvInt=2.518181818181818,
    nInt=1,
    RInt={4.674008494836554e-05},
    CInt={149744871.699451},
    RWin=0.005235244057932595,
    RExtRem=0.011825637168850083,
    AFloor=89.513260056,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0002924969492066612},
    RFloorRem=0.009203302885010475,
    CFloor={7972553.133495816},
    ARoof=89.513260056,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00026129987333171944},
    RRoofRem=0.012979271238313791,
    CRoof={32476103.074459184},
    ...
    nOrientations=4,
    AWin={15.025542060758054, 0.5673609935956977, 15.025542060758054, 0.5673609935956977},
    ATransparent={15.025542060758054, 0.5673609935956977, 15.025542060758054, 0.5673609935956977},
    AExt={45.07662618227416, 1.702082980787093, 45.07662618227416, 1.702082980787093})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*93.55741832612252)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*31.185806108707503)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=2237.8315014)
