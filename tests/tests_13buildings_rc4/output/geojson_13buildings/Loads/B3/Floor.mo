...
model Floor
  "This is the simulation model of Floor within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=35026.92784800001,
    hConvExt=2.7,
    hConvWin=2.6999999999999997,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={2.3050870993738167e-05},
    CExt={491089895.0078387},
    hRad=5.0,
    AInt=41837.71937399999,
    hConvInt=2.6069767441860465,
    nInt=1,
    RInt={2.310930370437709e-06},
    CInt={3051759632.9929953},
    RWin=0.00041881952463460764,
    RExtRem=0.0009460509735080067,
    AFloor=1118.9157506999998,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={2.33997559365329e-05},
    RFloorRem=0.0007362642308008379,
    CFloor={99656914.16869844},
    ARoof=1118.9157506999998,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={2.0903989866537556e-05},
    RRoofRem=0.0010383416990651032,
    CRoof={405951288.43074},
    ...
    nOrientations=4,
    AWin={187.81927575947566, 7.0920124199462204, 187.81927575947566, 7.0920124199462204},
    ATransparent={187.81927575947566, 7.0920124199462204, 187.81927575947566, 7.0920124199462204},
    AExt={563.457827278427, 21.27603725983866, 563.457827278427, 21.27603725983866})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1169.4677290765312)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*389.8225763588438)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=27972.893767499994)
