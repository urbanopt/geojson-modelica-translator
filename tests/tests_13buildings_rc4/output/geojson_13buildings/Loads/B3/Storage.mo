...
model Storage
  "This is the simulation model of Storage within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={3.841811832289695e-05},
    CExt={294653937.00470316},
    hRad=4.999999999999998,
    AInt=12843.2068776,
    hConvInt=2.5181818181818176,
    nInt=1,
    RInt={6.232011326448739e-06},
    CInt={1123086537.7458823},
    RWin=0.0006980325410576795,
    RExtRem=0.0015767516225133446,
    AFloor=671.3494504199998,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={3.899959322755484e-05},
    RFloorRem=0.0012271070513347302,
    CFloor={59794148.5012186},
    ARoof=671.3494504199998,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={3.483998311089593e-05},
    RRoofRem=0.001730569498441839,
    CRoof={243570773.05844393},
    ...
    nOrientations=4,
    AWin={112.69156545568539, 4.255207451967732, 112.69156545568539, 4.255207451967732},
    ATransparent={112.69156545568539, 4.255207451967732, 112.69156545568539, 4.255207451967732},
    AExt={338.07469636705616, 12.765622355903195, 338.07469636705616, 12.765622355903195})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.48180707621864927, 0.01819292378135073, 0.48180707621864927, 0.01819292378135073},
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*701.6806374459187)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*233.89354581530623)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=16783.736260499998)
