within geojson_13buildings.Loads.B3;
model Office
  "This is the simulation model of Office within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=70053.85569600001,
    hConvExt=2.7,
    hConvWin=2.6999999999999997,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={1.1525435496869084e-05},
    CExt={982179790.0156775},
    hRad=5.000000000000001,
    AInt=42810.68959200001,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={1.8696033979346219e-06},
    CInt={3743621792.4862747},
    RWin=0.00020940976231730382,
    RExtRem=0.00047302548675400333,
    AFloor=2237.8315013999995,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={1.169987796826645e-05},
    RFloorRem=0.00036813211540041895,
    CFloor={199313828.3373969},
    ARoof=2237.8315013999995,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={1.0451994933268778e-05},
    RRoofRem=0.0005191708495325516,
    CRoof={811902576.86148},
    ...
    nOrientations=4,
    AWin={375.6385515189513, 14.184024839892441, 375.6385515189513, 14.184024839892441},
    ATransparent={375.6385515189513, 14.184024839892441, 375.6385515189513, 14.184024839892441},
    AExt={1126.915654556854, 42.55207451967732, 1126.915654556854, 42.55207451967732})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.48180707621864927, 0.018192923781350734, 0.48180707621864927, 0.018192923781350734},
    wfWin={0.48180707621864927, 0.018192923781350734, 0.48180707621864927, 0.018192923781350734},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*2338.9354581530624)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*779.6451527176876)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=55945.78753499999)
