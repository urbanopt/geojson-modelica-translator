...
model Restroom
  "This is the simulation model of Restroom within building B3 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00014406794371086355},
    CExt={78574383.20125417},
    hRad=5.0,
    AInt=5292.957985920001,
    hConvInt=2.5823529411764707,
    nInt=1,
    RInt={1.727076421121793e-05},
    CInt={407370718.4402958},
    RWin=0.0026176220289662977,
    RExtRem=0.005912818584425042,
    AFloor=179.026520112,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0001462484746033306},
    RFloorRem=0.004601651442505237,
    CFloor={15945106.266991632},
    ARoof=179.026520112,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00013064993666585972},
    RRoofRem=0.006489635619156896,
    CRoof={64952206.14891837},
    ...
    nOrientations=4,
    AWin={30.05108412151611, 1.1347219871913954, 30.05108412151611, 1.1347219871913954},
    ATransparent={30.05108412151611, 1.1347219871913954, 30.05108412151611, 1.1347219871913954},
    AExt={90.15325236454832, 3.404165961574186, 90.15325236454832, 3.404165961574186})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4818070762186493, 0.018192923781350734, 0.4818070762186493, 0.018192923781350734},
    wfWin={0.4818070762186493, 0.018192923781350737, 0.4818070762186493, 0.018192923781350737},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*187.11483665224503)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*62.371612217415006)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B3/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=4475.6630028)
