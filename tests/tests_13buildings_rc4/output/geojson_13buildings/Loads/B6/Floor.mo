...
model Floor
  "This is the simulation model of Floor within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0002497872898040095},
    CExt={45318758.3124672},
    hRad=5.0,
    AInt=3228.526938,
    hConvInt=2.7,
    nInt=1,
    RInt={3.827955719864664e-05},
    CInt={201675937.2205986},
    RWin=0.004538474663447703,
    RExtRem=0.01025173880645137,
    AFloor=285.6004599,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={9.16747665220496e-05},
    RFloorRem=0.002884510917134127,
    CFloor={25437179.252315737},
    ARoof=285.6004599,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={8.189693924978886e-05},
    RRoofRem=0.004067979729792247,
    CRoof={103618055.78327437},
    ...
    nOrientations=4,
    AWin={15.668849214130502, 2.3179545282553438, 15.668849214130502, 2.3179545282553438},
    ATransparent={15.668849214130502, 2.3179545282553438, 15.668849214130502, 2.3179545282553438},
    AExt={47.0065476423915, 6.953863584766031, 47.0065476423915, 6.953863584766031})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*107.92082245431507)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.99999999999999*35.97360748477169)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=7140.0114975000015)
