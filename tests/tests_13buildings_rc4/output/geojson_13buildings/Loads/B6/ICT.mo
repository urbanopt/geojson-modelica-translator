...
model ICT
  "This is the simulation model of ICT within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00312234112255012},
    CExt={3625500.6649973765},
    hRad=5.0,
    AInt=119.20714848,
    hConvInt=2.7,
    nInt=1,
    RInt={0.0010367380074633465},
    CInt={7446496.143529827},
    RWin=0.056730933293096295,
    RExtRem=0.12814673508064214,
    AFloor=22.848036792,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00114593458152562},
    RFloorRem=0.03605638646417659,
    CFloor={2034974.340185243},
    ARoof=22.848036792,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0010237117406223608},
    RRoofRem=0.05084974662240309,
    CRoof={8289444.462661949},
    ...
    nOrientations=4,
    AWin={1.25350793713044, 0.18543636226042748, 1.25350793713044, 0.18543636226042748},
    ATransparent={1.25350793713044, 0.18543636226042748, 1.25350793713044, 0.18543636226042748},
    AExt={3.7605238113913204, 0.5563090867812825, 3.7605238113913204, 0.5563090867812825})
    "Thermal zone"
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=571.2009198000001)
