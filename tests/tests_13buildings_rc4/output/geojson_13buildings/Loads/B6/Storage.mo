...
model Storage
  "This is the simulation model of Storage within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0004163121496733493},
    CExt={27191254.987480327},
    hRad=4.999999999999999,
    AInt=894.0536136000001,
    hConvInt=2.7,
    nInt=1,
    RInt={0.00013823173432844622},
    CInt={55848721.07647369},
    RWin=0.007564124439079507,
    RExtRem=0.017086231344085615,
    AFloor=171.36027593999998,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00015279127753674933},
    RFloorRem=0.004807518195223547,
    CFloor={15262307.551389087},
    ARoof=171.36027593999998,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0001364948987496481},
    RRoofRem=0.006779966216320411,
    CRoof={62170833.4699646},
    ...
    nOrientations=4,
    AWin={9.4013095284783, 1.390772716953206, 9.4013095284783, 1.390772716953206},
    ATransparent={9.4013095284783, 1.390772716953206, 9.4013095284783, 1.390772716953206},
    AExt={28.203928585434902, 4.172318150859619, 28.203928585434902, 4.172318150859619})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4355651353777467, 0.06443486462225335, 0.4355651353777467, 0.06443486462225335},
    wfWin={0.43556513537774666, 0.06443486462225334, 0.43556513537774666, 0.06443486462225334},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*64.75249347258904)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=4284.0068985)
