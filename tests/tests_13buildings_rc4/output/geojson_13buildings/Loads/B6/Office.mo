within geojson_13buildings.Loads.B6;
model Office
  "This is the simulation model of Office within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00012489364490200476},
    CExt={90637516.6249344},
    hRad=5.0,
    AInt=2980.1787120000004,
    hConvInt=2.7,
    nInt=1,
    RInt={4.146952029853386e-05},
    CInt={186162403.58824486},
    RWin=0.0022692373317238514,
    RExtRem=0.005125869403225685,
    AFloor=571.2009198,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={4.58373832610248e-05},
    RFloorRem=0.0014422554585670636,
    CFloor={50874358.504631475},
    ARoof=571.2009198,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={4.094846962489443e-05},
    RRoofRem=0.0020339898648961234,
    CRoof={207236111.56654873},
    ...
    nOrientations=4,
    AWin={31.337698428261003, 4.6359090565106875, 31.337698428261003, 4.6359090565106875},
    ATransparent={31.337698428261003, 4.6359090565106875, 31.337698428261003, 4.6359090565106875},
    AExt={94.013095284783, 13.907727169532063, 94.013095284783, 13.907727169532063})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4355651353777466, 0.06443486462225335, 0.4355651353777466, 0.06443486462225335},
    wfWin={0.43556513537774666, 0.06443486462225335, 0.43556513537774666, 0.06443486462225335},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=19.999999999999993,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*215.84164490863014)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.99999999999999*71.94721496954338)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=14280.022995000003)
