...
model Meeting
  "This is the simulation model of Meeting within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hConvInt=2.7,
    nInt=1,
    RInt={0.0005183690037316733},
    CInt={14892992.287059654},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_Meeting.txt"),
    columns={2,3,4})
