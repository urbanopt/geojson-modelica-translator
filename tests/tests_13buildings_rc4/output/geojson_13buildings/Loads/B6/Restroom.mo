...
model Restroom
  "This is the simulation model of Restroom within building B6 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00156117056127506},
    CExt={7251001.329994753},
    hRad=5.0,
    AInt=397.3571616,
    hConvInt=2.7,
    nInt=1,
    RInt={0.000311021402239004},
    CInt={24821653.811765976},
    RWin=0.028365466646548147,
    RExtRem=0.06407336754032107,
    AFloor=45.696073584,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00057296729076281},
    RFloorRem=0.018028193232088294,
    CFloor={4069948.680370486},
    ARoof=45.696073584,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0005118558703111804},
    RRoofRem=0.025424873311201544,
    CRoof={16578888.925323898},
    ...
    nOrientations=4,
    AWin={2.50701587426088, 0.37087272452085496, 2.50701587426088, 0.37087272452085496},
    ATransparent={2.50701587426088, 0.37087272452085496, 2.50701587426088, 0.37087272452085496},
    AExt={7.521047622782641, 1.112618173562565, 7.521047622782641, 1.112618173562565})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.43556513537774666, 0.06443486462225337, 0.43556513537774666, 0.06443486462225337},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B6/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1142.4018396000001)
