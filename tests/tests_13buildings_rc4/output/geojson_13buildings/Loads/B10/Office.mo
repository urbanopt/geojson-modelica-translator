...
model Office
  "This is the simulation model of Office within building B10 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.181928267818529e-06},
    CExt={9577611539.021225},
    hRad=5.0,
    AInt=460380.594768,
    hConvInt=2.474193548387097,
    nInt=1,
    RInt={1.6018703221349432e-07},
    CInt={43566157248.67566},
    RWin=2.147487769179887e-05,
    RExtRem=4.850855261348275e-05,
    AFloor=8539.3174836,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={3.0660946299521528e-06},
    RFloorRem=9.647347649296827e-05,
    CFloor={760559522.904198},
    ARoof=8539.3174836,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={2.7390717769965616e-06},
    RRoofRem=0.0001360550048553465,
    CRoof={3098130429.049617},
    ...
    nOrientations=4,
    AWin={3764.062416206663, 37.24691988327082, 3764.062416206663, 37.24691988327082},
    ATransparent={3764.062416206663, 37.24691988327082, 3764.062416206663, 37.24691988327082},
    AExt={11292.187248619988, 111.74075964981247, 11292.187248619988, 111.74075964981247})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*22807.8560165396)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*7602.618672179867)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=213482.93709)
