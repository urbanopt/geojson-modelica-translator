...
model Restroom
  "This is the simulation model of Restroom within building B10 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=57027.789803520005,
    hConvExt=2.7,
    hConvWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={1.4774103347731605e-05},
    CExt={766208923.1216986},
    hRad=4.999999999999999,
    AInt=55839.710849279996,
    hConvInt=2.551063829787234,
    nInt=1,
    RInt={1.5309942473179292e-06},
    CInt={4583056397.336766},
    RWin=0.0002684359711474859,
    RExtRem=0.0006063569076685343,
    AFloor=683.145398688,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={3.83261828744019e-05},
    RFloorRem=0.0012059184561621034,
    CFloor={60844761.83233586},
    ARoof=683.145398688,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={3.4238397212457025e-05},
    RRoofRem=0.0017006875606918313,
    CRoof={247850434.32396933},
    ...
    nOrientations=4,
    AWin={301.12499329653303, 2.979753590661666, 301.12499329653303, 2.979753590661666},
    ATransparent={301.12499329653303, 2.979753590661666, 301.12499329653303, 2.979753590661666},
    AExt={903.3749798895991, 8.939260771984998, 903.3749798895991, 8.939260771984998})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.495100777575552, 0.004899222424448018, 0.495100777575552, 0.004899222424448018},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1824.628481323168)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*608.2094937743893)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=17078.634967200003)
