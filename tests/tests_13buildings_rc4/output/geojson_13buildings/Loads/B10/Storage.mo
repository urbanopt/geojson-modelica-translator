within geojson_13buildings.Loads.B10;
model Storage
  "This is the simulation model of Storage within building B10 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.0017821341055906)
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={3.93976089272843e-06},
    CExt={2873283461.706366},
    hRad=5.000000000000002,
    AInt=138114.17843039997,
    hConvInt=2.4741935483870967,
    nInt=1,
    RInt={5.339567740449808e-07},
    CInt={13069847174.6027},
    RWin=7.158292563932958e-05,
    RExtRem=0.00016169517537827584,
    AFloor=2561.79524508,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={1.022031543317384e-05},
    RFloorRem=0.00032157825497656085,
    CFloor={228167856.87126297},
    ARoof=2561.79524508,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={9.130239256655206e-06},
    RRoofRem=0.00045351668285115507,
    CRoof={929439128.7148854},
    ...
    nOrientations=4,
    AWin={1129.2187248619987, 11.174075964981245, 1129.2187248619987, 11.174075964981245},
    ATransparent={1129.2187248619987, 11.174075964981245, 1129.2187248619987, 11.174075964981245},
    AExt={3387.6561745859963, 33.52222789494374, 3387.6561745859963, 33.52222789494374})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.495100777575552, 0.004899222424448018, 0.495100777575552, 0.004899222424448018},
    wfWin={0.495100777575552, 0.004899222424448019, 0.495100777575552, 0.004899222424448019},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=19.999999999999996,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.99999999999999*6842.356804961881)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*2280.78560165396)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    aExt=0.5,
    wfGro=0,
    hConvWallOut=20.000000000000004,
    hRad=4.999999999999999,
    n=1,
    wfWall={1.0},
    wfWin={0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=64044.88112699999)
