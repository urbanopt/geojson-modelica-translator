...
model Meeting
  "This is the simulation model of Meeting within building B10 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=36830.44758144,
    hConvInt=2.474193548387097,
    nInt=1,
    RInt={2.0023379026686782e-06},
    CInt={3485292579.8940535},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_Meeting.txt"),
    columns={2,3,4})
