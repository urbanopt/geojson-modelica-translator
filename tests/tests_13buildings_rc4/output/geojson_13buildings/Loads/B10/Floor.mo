...
model Floor
  "This is the simulation model of Floor within building B10 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={2.363856535637058e-06},
    CExt={4788805769.5106125},
    hRad=5.0,
    AInt=438104.114376,
    hConvInt=2.5813559322033894,
    nInt=1,
    RInt={2.0819727118311293e-07},
    CInt={33789877667.144714},
    RWin=4.294975538359774e-05,
    RExtRem=9.70171052269655e-05,
    AFloor=4269.6587418,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={6.1321892599043055e-06},
    RFloorRem=0.00019294695298593655,
    CFloor={380279761.452099},
    ARoof=4269.6587418,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={5.478143553993123e-06},
    RRoofRem=0.000272110009710693,
    CRoof={1549065214.5248084},
    ...
    nOrientations=4,
    AWin={1882.0312081033314, 18.62345994163541, 1882.0312081033314, 18.62345994163541},
    ATransparent={1882.0312081033314, 18.62345994163541, 1882.0312081033314, 18.62345994163541},
    AExt={5646.093624309994, 55.87037982490624, 5646.093624309994, 55.87037982490624})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.49510077757555193, 0.004899222424448018, 0.49510077757555193, 0.004899222424448018},
    wfWin={0.495100777575552, 0.0048992224244480175, 0.495100777575552, 0.0048992224244480175},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.000000000000001,
    hConvWinOut=20.000000000000007,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*11403.9280082698)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000007*3801.3093360899334)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=106741.468545)
