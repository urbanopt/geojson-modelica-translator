...
model ICT
  "This is the simulation model of ICT within building B10 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=28513.894901760003,
    hConvExt=2.7,
    hConvWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={2.954820669546321e-05},
    CExt={383104461.5608493},
    hRad=4.999999999999999,
    AInt=18415.22379072,
    hConvInt=2.474193548387097,
    nInt=1,
    RInt={4.0046758053373565e-06},
    CInt={1742646289.9470267},
    RWin=0.0005368719422949718,
    RExtRem=0.0012127138153370685,
    AFloor=341.572699344,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={7.66523657488038e-05},
    RFloorRem=0.0024118369123242067,
    CFloor={30422380.91616793},
    ARoof=341.572699344,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={6.847679442491405e-05},
    RRoofRem=0.0034013751213836626,
    CRoof={123925217.16198467},
    ...
    nOrientations=4,
    AWin={150.56249664826652, 1.489876795330833, 150.56249664826652, 1.489876795330833},
    ATransparent={150.56249664826652, 1.489876795330833, 150.56249664826652, 1.489876795330833},
    AExt={451.68748994479955, 4.469630385992499, 451.68748994479955, 4.469630385992499})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*912.314240661584)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*304.10474688719466)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B10/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=8539.317483600002)
