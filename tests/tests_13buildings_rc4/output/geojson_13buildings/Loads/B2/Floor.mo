...
model Floor
  "This is the simulation model of Floor within building B2 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00012303404973617834},
    CExt={92007455.17543861},
    hRad=5.0,
    AInt=6739.463146,
    hConvInt=2.6999999999999997,
    nInt=1,
    RInt={1.8337748706867477e-05},
    CInt={420993094.50867397},
    RWin=0.0022354496816356694,
    RExtRem=0.005049548130270799,
    AFloor=596.1832783,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={4.391662167141075e-05},
    RFloorRem=0.0013818194412784782,
    CFloor={53099427.510236375},
    ARoof=596.1832783,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={3.923257220638162e-05},
    RRoofRem=0.0019487579138506397,
    CRoof={216299904.45244652},
    ...
    nOrientations=4,
    AWin={34.10069944305848, 2.416630261045718, 34.10069944305848, 2.416630261045718},
    ATransparent={34.10069944305848, 2.416630261045718, 34.10069944305848, 2.416630261045718},
    AExt={102.30209832917545, 7.249890783137153, 102.30209832917545, 7.249890783137153})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*219.1039782246252)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*73.0346594082084)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B2/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=14904.581957500002)
