...
model Meeting
  "This is the simulation model of Meeting within building B2 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0007689628108511145},
    CExt={14721192.828070175},
    hRad=5.0,
    AInt=497.68343232,
    hConvInt=2.7000000000000006,
    nInt=1,
    RInt={0.0002483236804054971},
    CInt={31088720.82525592},
    RWin=0.013971560510222934,
    RExtRem=0.03155967581419251,
    AFloor=95.38932452799999,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00027447888544631727},
    RFloorRem=0.00863637150799049,
    CFloor={8495908.401637752},
    ARoof=95.38932452799999,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.00024520357628988516},
    RRoofRem=0.012179736961566498,
    CRoof={34607984.712391436},
    ...
    nOrientations=4,
    AWin={5.456111910889357, 0.38666084176731486, 5.456111910889357, 0.38666084176731486},
    ATransparent={5.456111910889357, 0.38666084176731486, 5.456111910889357, 0.38666084176731486},
    AExt={16.368335732668072, 1.1599825253019445, 16.368335732668072, 1.1599825253019445})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*35.05663651594003)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B2/InternalGains_Meeting.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=2384.7331132)
