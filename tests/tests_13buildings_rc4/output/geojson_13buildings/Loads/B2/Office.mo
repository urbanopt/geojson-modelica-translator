...
model Office
  "This is the simulation model of Office within building B2 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.00178213410559)
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={6.151702486808917e-05},
    CExt={184014910.35087723},
    hRad=5.0,
    AInt=6221.042904,
    hConvInt=2.7000000000000006,
    nInt=1,
    RInt={1.9865894432439765e-05},
    CInt={388609010.31570077},
    RWin=0.0011177248408178347,
    RExtRem=0.0025247740651353997,
    AFloor=1192.3665566,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={2.1958310835705376e-05},
    RFloorRem=0.0006909097206392391,
    CFloor={106198855.02047275},
    ARoof=1192.3665566,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={1.961628610319081e-05},
    RRoofRem=0.0009743789569253198,
    CRoof={432599808.90489304},
    ...
    nOrientations=4,
    AWin={68.20139888611696, 4.833260522091436, 68.20139888611696, 4.833260522091436},
    ATransparent={68.20139888611696, 4.833260522091436, 68.20139888611696, 4.833260522091436},
    AExt={204.6041966583509, 14.499781566274306, 204.6041966583509, 14.499781566274306})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.46691118599542475, 0.033088814004575355, 0.46691118599542475, 0.033088814004575355},
    wfWin={0.46691118599542464, 0.033088814004575376, 0.46691118599542464, 0.033088814004575376},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*438.2079564492504)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*146.0693188164168)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B2/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=29809.163915000005)
