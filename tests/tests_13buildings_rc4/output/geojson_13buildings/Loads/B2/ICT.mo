...
model ICT
  "This is the simulation model of ICT within building B2 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.001537925621702229},
    CExt={7360596.414035087},
    hRad=5.0,
    AInt=248.84171616,
    hConvInt=2.7000000000000006,
    nInt=1,
    RInt={0.0004966473608109942},
    CInt={15544360.41262796},
    RWin=0.02794312102044587,
    RExtRem=0.06311935162838501,
    AFloor=47.694662263999994,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0005489577708926345},
    RFloorRem=0.01727274301598098,
    CFloor={4247954.200818876},
    ARoof=47.694662263999994,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0004904071525797703},
    RRoofRem=0.024359473923132997,
    CRoof={17303992.356195718},
    ...
    nOrientations=4,
    AWin={2.7280559554446784, 0.19333042088365743, 2.7280559554446784, 0.19333042088365743},
    ATransparent={2.7280559554446784, 0.19333042088365743, 2.7280559554446784, 0.19333042088365743},
    AExt={8.184167866334036, 0.5799912626509722, 8.184167866334036, 0.5799912626509722})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4669111859954247, 0.033088814004575355, 0.4669111859954247, 0.033088814004575355},
    wfWin={0.4669111859954246, 0.03308881400457536, 0.4669111859954246, 0.03308881400457536},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*17.528318257970014)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*5.842772752656671)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B2/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1192.3665566)
