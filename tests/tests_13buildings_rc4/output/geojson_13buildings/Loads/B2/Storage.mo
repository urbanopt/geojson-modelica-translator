...
model Storage
  "This is the simulation model of Storage within building B2 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=3732.6257423999996,
    hConvExt=2.6999999999999997,
    hConvWin=2.7,
    gWin=0.7800000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.00020505674956029722},
    CExt={55204473.10526315},
    hRad=4.999999999999999,
    AInt=1866.3128711999998,
    hConvInt=2.7,
    nInt=1,
    RInt={6.621964810813256e-05},
    CInt={116582703.09470971},
    RWin=0.0037257494693927824,
    RExtRem=0.008415913550451334,
    AFloor=357.70996697999993,
    hConvFloor=1.7,
    nFloor=1,
    RFloor={7.319436945235126e-05},
    RFloorRem=0.0023030324021307974,
    CFloor={31859656.506142072},
    ARoof=357.70996697999993,
    hConvRoof=1.7,
    nRoof=1,
    RRoof={6.538762034396938e-05},
    RRoofRem=0.0032479298564177333,
    CRoof={129779942.6714679},
    ...
    nOrientations=4,
    AWin={20.460419665835087, 1.4499781566274306, 20.460419665835087, 1.4499781566274306},
    ATransparent={20.460419665835087, 1.4499781566274306, 20.460419665835087, 1.4499781566274306},
    AExt={61.38125899750526, 4.3499344698822915, 61.38125899750526, 4.3499344698822915})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.46691118599542464, 0.03308881400457536, 0.46691118599542464, 0.03308881400457536},
    wfWin={0.46691118599542464, 0.03308881400457536, 0.46691118599542464, 0.03308881400457536},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*131.4623869347751)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*43.820795644925035)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B2/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=8942.7491745)
