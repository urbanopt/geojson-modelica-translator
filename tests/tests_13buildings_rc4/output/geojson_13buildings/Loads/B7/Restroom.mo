...
model Restroom
  "This is the simulation model of Restroom within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.0015611705612750596},
    CExt={7251001.329994753},
    hRad=5.0,
    AInt=463.58335519999997,
    hConvInt=2.5571428571428574,
    nInt=1,
    RInt={0.00018676319768366558},
    CInt={37588408.521660015},
    RWin=0.028365466646548147,
    RExtRem=0.06407336754032106,
    AFloor=7.616012264,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00343780374457686},
    RFloorRem=0.10816915939252977,
    CFloor={678324.7800617424},
    ARoof=7.616012264,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0030711352218670824},
    RRoofRem=0.15254923986720925,
    CRoof={2763148.1542206495},
    ...
    nOrientations=4,
    AWin={1.5246254983820506, 1.353263100399685, 1.5246254983820506, 1.353263100399685},
    ATransparent={1.5246254983820506, 1.353263100399685, 1.5246254983820506, 1.353263100399685},
    AExt={4.573876495146152, 4.0597893011990545, 4.573876495146152, 4.0597893011990545})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.2648861215523515, 0.23511387844764847, 0.2648861215523515, 0.23511387844764847},
    wfWin={0.26488612155235153, 0.23511387844764853, 0.26488612155235153, 0.23511387844764853},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*17.26733159269041)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*5.7557771975634715)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=190.40030660000002)
