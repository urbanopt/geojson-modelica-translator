...
model Meeting
  "This is the simulation model of Meeting within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=304.64049056,
    hConvInt=2.4826086956521745,
    nInt=1,
    RInt={0.00024577524758898485},
    CInt={28409632.932707936},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_Meeting.txt"),
    columns={2,3,4})
