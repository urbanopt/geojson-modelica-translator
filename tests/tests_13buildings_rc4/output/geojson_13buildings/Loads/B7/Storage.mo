...
model Storage
  "This is the simulation model of Storage within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.00041631214967334913},
    CExt={27191254.987480324},
    hRad=5.0,
    AInt=1142.4018396000001,
    hConvInt=2.4826086956521736,
    nInt=1,
    RInt={6.554006602372932e-05},
    CInt={106536123.49765475},
    RWin=0.0075641244390795065,
    RExtRem=0.017086231344085618,
    AFloor=28.56004599,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0009167476652204959},
    RFloorRem=0.028845109171341275,
    CFloor={2543717.925231554},
    ARoof=28.56004599,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0008189693924978885},
    RRoofRem=0.04067979729792246,
    CRoof={10361805.578327438},
    ...
    nOrientations=4,
    AWin={5.71734561893269, 5.074736626498818, 5.71734561893269, 5.074736626498818},
    ATransparent={5.71734561893269, 5.074736626498818, 5.71734561893269, 5.074736626498818},
    AExt={17.15203685679807, 15.224209879496454, 17.15203685679807, 15.224209879496454})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.26488612155235153, 0.2351138784476485, 0.26488612155235153, 0.2351138784476485},
    wfWin={0.26488612155235153, 0.23511387844764847, 0.26488612155235153, 0.23511387844764847},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.99999999999999*64.75249347258905)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*21.584164490863017)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=714.0011497500001)
