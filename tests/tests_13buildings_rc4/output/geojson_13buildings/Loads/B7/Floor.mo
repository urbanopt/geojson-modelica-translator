...
model Floor
  "This is the simulation model of Floor within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=3642.440648,
    hConvInt=2.5863636363636364,
    nInt=1,
    RInt={2.5321605115936068e-05},
    CInt={277953122.5997028},
    RWin=0.004538474663447703,
    RExtRem=0.010251738806451369,
    AFloor=47.60007665,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={0.0005500485991322975},
    RFloorRem=0.017307065502804763,
    CFloor={4239529.875385923},
    ARoof=47.60007665,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={0.0004913816354987331},
    RRoofRem=0.024407878378753477,
    CRoof={17269675.96387907},
    ...
    nOrientations=4,
    AWin={9.528909364887816, 8.45789437749803, 9.528909364887816, 8.45789437749803},
    ATransparent={9.528909364887816, 8.45789437749803, 9.528909364887816, 8.45789437749803},
    AExt={28.58672809466345, 25.37368313249409, 28.58672809466345, 25.37368313249409})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*107.92082245431509)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*35.97360748477169)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1190.0019162500002)
