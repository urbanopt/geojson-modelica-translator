...
model ICT
  "This is the simulation model of ICT within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={0.003122341122550119},
    CExt={3625500.6649973765},
    hRad=4.999999999999999,
    AInt=152.32024528,
    hConvInt=2.4826086956521745,
    nInt=1,
    RInt={0.0004915504951779697},
    CInt={14204816.466353968},
    RWin=0.056730933293096295,
    RExtRem=0.12814673508064212,
    AFloor=3.808006132,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00687560748915372},
    RFloorRem=0.21633831878505955,
    CFloor={339162.3900308712},
    ARoof=3.808006132,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.006142270443734165},
    RRoofRem=0.3050984797344185,
    CRoof={1381574.0771103248},
    ...
    nOrientations=4,
    AWin={0.7623127491910253, 0.6766315501998424, 0.7623127491910253, 0.6766315501998424},
    ATransparent={0.7623127491910253, 0.6766315501998424, 0.7623127491910253, 0.6766315501998424},
    AExt={2.286938247573076, 2.0298946505995272, 2.286938247573076, 2.0298946505995272})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*8.633665796345205)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=95.20015330000001)
