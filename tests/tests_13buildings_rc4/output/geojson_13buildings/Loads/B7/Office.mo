within geojson_13buildings.Loads.B7;
model Office
  "This is the simulation model of Office within building B7 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=5960.357424,
    hConvExt=2.6999999999999993,
    hConvWin=2.700000000000001,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    ...
    AInt=3808.0061320000004,
    hConvInt=2.482608695652174,
    nInt=1,
    RInt={1.9662019807118798e-05},
    CInt={355120411.6588493},
    RWin=0.0022692373317238514,
    RExtRem=0.0051258694032256845,
    AFloor=95.2001533,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={0.00027502429956614876},
    RFloorRem=0.008653532751402382,
    CFloor={8479059.750771847},
    ARoof=95.2001533,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={0.00024569081774936655},
    RRoofRem=0.012203939189376739,
    CRoof={34539351.92775814},
    ...
    nOrientations=4,
    AWin={19.057818729775633, 16.91578875499606, 19.057818729775633, 16.91578875499606},
    ATransparent={19.057818729775633, 16.91578875499606, 19.057818729775633, 16.91578875499606},
    AExt={57.1734561893269, 50.74736626498818, 57.1734561893269, 50.74736626498818})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.26488612155235153, 0.23511387844764847, 0.26488612155235153, 0.23511387844764847},
    wfWin={0.26488612155235153, 0.23511387844764844, 0.26488612155235153, 0.23511387844764844},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*215.84164490863017)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*71.94721496954338)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B7/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=2380.0038325000005)
