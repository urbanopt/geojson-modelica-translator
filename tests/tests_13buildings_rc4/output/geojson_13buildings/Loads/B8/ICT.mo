...
model ICT
  "This is the simulation model of ICT within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0031223411225501205},
    CExt={3625500.6649973756},
    hRad=4.999999999999999,
    AInt=154.96929302400002,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={0.0004716974303843426},
    CInt={14790476.023645282},
    RWin=0.056730933293096295,
    RExtRem=0.12814673508064214,
    AFloor=2.2848036792,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.011459345815256199},
    RFloorRem=0.3605638646417659,
    CFloor={203497.4340185243},
    ARoof=2.2848036792,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.010237117406223607},
    RRoofRem=0.5084974662240308,
    CRoof={828944.4462661954},
    ...
    nOrientations=4,
    AWin={0.5803740810090033, 0.8585702183818643, 0.5803740810090033, 0.8585702183818643},
    ATransparent={0.5803740810090033, 0.8585702183818643, 0.5803740810090033, 0.8585702183818643},
    AExt={1.74112224302701, 2.575710655145593, 1.74112224302701, 2.575710655145593})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*8.633665796345205)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*2.8778885987817353)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=57.120091980000005)
