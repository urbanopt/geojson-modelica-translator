...
model Restroom
  "This is the simulation model of Restroom within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0015611705612750602},
    CExt={7251001.329994751},
    hRad=4.999999999999999,
    AInt=468.88145068800003,
    hConvInt=2.5474576271186438,
    nInt=1,
    RInt={0.00018097645108271782},
    CInt={38759724.63902727},
    RWin=0.028365466646548147,
    RExtRem=0.06407336754032107,
    AFloor=4.5696073584,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.005729672907628099},
    RFloorRem=0.18028193232088294,
    CFloor={406994.8680370486},
    ARoof=4.5696073584,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.005118558703111804},
    RRoofRem=0.2542487331120154,
    CRoof={1657888.8925323908},
    ...
    nOrientations=4,
    AWin={1.1607481620180067, 1.7171404367637286, 1.1607481620180067, 1.7171404367637286},
    ATransparent={1.1607481620180067, 1.7171404367637286, 1.1607481620180067, 1.7171404367637286},
    AExt={3.48224448605402, 5.151421310291186, 3.48224448605402, 5.151421310291186})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWin={0.20166662505792848, 0.2983333749420715, 0.20166662505792848, 0.2983333749420715},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*17.26733159269041)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*5.755777197563471)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=114.24018396000001)
