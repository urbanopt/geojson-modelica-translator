...
model Meeting
  "This is the simulation model of Meeting within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    AInt=309.93858604800005,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={0.0002358487151921713},
    CInt={29580952.047290564},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_Meeting.txt"),
    columns={2,3,4})
