within geojson_13buildings.Loads.B8;
model Storage
  "This is the simulation model of Storage within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=1788.1072272000001,
    hConvExt=2.6999999999999997,
    hConvWin=2.7,
    gWin=0.7800000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.00041631214967334935},
    CExt={27191254.987480313},
    hRad=4.999999999999998,
    AInt=1162.2696976800003,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={6.289299071791235e-05},
    CInt={110928570.1773396},
    RWin=0.007564124439079507,
    RExtRem=0.01708623134408562,
    AFloor=17.136027593999998,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0015279127753674933},
    RFloorRem=0.04807518195223545,
    CFloor={1526230.7551389204},
    ARoof=17.136027593999998,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0013649489874964812},
    RRoofRem=0.06779966216320411,
    CRoof={6217083.346996461},
    ...
    nOrientations=4,
    AWin={4.352805607567524, 6.4392766378639825, 4.352805607567524, 6.4392766378639825},
    ATransparent={4.352805607567524, 6.4392766378639825, 4.352805607567524, 6.4392766378639825},
    AExt={13.058416822702574, 19.317829913591943, 13.058416822702574, 19.317829913591943})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.20166662505792848, 0.2983333749420715, 0.20166662505792848, 0.2983333749420715},
    wfWin={0.20166662505792843, 0.29833337494207157, 0.20166662505792843, 0.29833337494207157},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*64.75249347258904)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*21.584164490863014)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=428.40068985)
