...
model Floor
  "This is the simulation model of Floor within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    CExt={45318758.31246718},
    hRad=4.999999999999999,
    AInt=3675.5537448000005,
    hConvInt=2.5783783783783782,
    nInt=1,
    RInt={2.4653698546783154e-05},
    CInt={285273837.71761113},
    RWin=0.004538474663447704,
    ...
    nOrientations=4,
    AWin={7.254676012612541, 10.732127729773303, 7.254676012612541, 10.732127729773303},
    ATransparent={7.254676012612541, 10.732127729773303, 7.254676012612541, 10.732127729773303},
    AExt={21.764028037837623, 32.19638318931991, 21.764028037837623, 32.19638318931991})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*107.92082245431507)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_Floor.txt"),
    columns={2,3,4})
