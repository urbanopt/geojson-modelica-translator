...
model Office
  "This is the simulation model of Office within building B8 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    CExt={90637516.62493436},
    hRad=5.0,
    AInt=3874.2323256000004,
    hConvInt=2.469230769230769,
    nInt=1,
    RInt={1.8867897215373707e-05},
    CInt={369761900.59113204},
    RWin=0.002269237331723852,
    ...
    nOrientations=4,
    AWin={14.509352025225082, 21.464255459546607, 14.509352025225082, 21.464255459546607},
    ATransparent={14.509352025225082, 21.464255459546607, 14.509352025225082, 21.464255459546607},
    AExt={43.528056075675245, 64.39276637863982, 43.528056075675245, 64.39276637863982})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.20166662505792846, 0.2983333749420715, 0.20166662505792846, 0.2983333749420715},
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*215.84164490863014)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B8/InternalGains_Office.txt"),
    columns={2,3,4})
