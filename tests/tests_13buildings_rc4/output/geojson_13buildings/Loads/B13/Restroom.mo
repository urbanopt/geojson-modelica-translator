within geojson_13buildings.Loads.B13;
model Restroom
  "This is the simulation model of Restroom within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=14103.669964800001,
    hConvExt=2.7,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={5.847080905217567e-05},
    CExt={193601730.49859473},
    hRad=5.000000000000002,
    AInt=13868.60879872,
    hConvInt=2.547457627118644,
    nInt=1,
    RInt={6.1186022445064845e-06},
    CInt={1146437883.9811828},
    RWin=0.0010623770554650867,
    RExtRem=0.0023997516553989832,
    AFloor=135.16017049599998,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.00019371354285689765},
    RFloorRem=0.006095121377080966,
    CFloor={12038123.068443567},
    ARoof=135.16017049599998,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0001730524860120258},
    RRoofRem=0.008595852442542804,
    CRoof={49037155.23089531},
    ...
    nOrientations=4,
    AWin={73.1795670063976, 3.660056591730091, 73.1795670063976, 3.660056591730091},
    ATransparent={73.1795670063976, 3.660056591730091, 73.1795670063976, 3.660056591730091},
    AExt={219.53870101919276, 10.980169775190273, 219.53870101919276, 10.980169775190273})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4761837941133584, 0.023816205886641493, 0.4761837941133584, 0.023816205886641493},
    wfWin={0.47618379411335854, 0.023816205886641496, 0.47618379411335854, 0.023816205886641496},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*461.0377415887661)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*153.6792471962554)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=3379.0042624000002)
