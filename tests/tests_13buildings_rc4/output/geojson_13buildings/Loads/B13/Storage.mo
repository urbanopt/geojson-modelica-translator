...
model Storage
  "This is the simulation model of Storage within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={1.559221574724685e-05},
    CExt={726006489.3697301},
    hRad=5.000000000000001,
    AInt=34377.6955392,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={2.126338492484074e-06},
    CInt={3281053115.0966134},
    RWin=0.00028330054812402317,
    RExtRem=0.0006399337747730623,
    AFloor=506.85063935999995,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={5.165694476183937e-05},
    RFloorRem=0.001625365700554924,
    CFloor={45142961.506663375},
    ARoof=506.85063935999995,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={4.614732960320688e-05},
    RRoofRem=0.0022922273180114145,
    CRoof={183889332.1158575},
    ...
    nOrientations=4,
    AWin={274.423376273991, 13.72521221898784, 274.423376273991, 13.72521221898784},
    ATransparent={274.423376273991, 13.72521221898784, 274.423376273991, 13.72521221898784},
    AExt={823.2701288219729, 41.17563665696352, 823.2701288219729, 41.17563665696352})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.47618379411335854, 0.023816205886641503, 0.47618379411335854, 0.023816205886641503},
    wfWin={0.4761837941133585, 0.023816205886641496, 0.4761837941133585, 0.023816205886641496},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*1728.8915309578729)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*576.2971769859577)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=12671.265984)
