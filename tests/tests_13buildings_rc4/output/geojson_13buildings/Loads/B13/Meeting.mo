...
model Meeting
  "This is the simulation model of Meeting within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nInt=1,
    RInt={7.973769346815279e-06},
    CInt={874947497.3590968},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_Meeting.txt"),
    columns={2,3,4})
