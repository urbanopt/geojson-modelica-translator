...
model ICT
  "This is the simulation model of ICT within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=7051.834982400001,
    hConvExt=2.7,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={0.00011694161810435134},
    CExt={96800865.24929737},
    hRad=5.000000000000001,
    AInt=4583.69273856,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={1.5947538693630557e-05},
    CInt={437473748.6795484},
    RWin=0.0021247541109301734,
    RExtRem=0.0047995033107979665,
    AFloor=67.58008524799999,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={0.0003874270857137953},
    RFloorRem=0.012190242754161931,
    CFloor={6019061.534221783},
    ARoof=67.58008524799999,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={0.0003461049720240516},
    RRoofRem=0.017191704885085608,
    CRoof={24518577.615447655},
    ...
    nOrientations=4,
    AWin={36.5897835031988, 1.8300282958650456, 36.5897835031988, 1.8300282958650456},
    ATransparent={36.5897835031988, 1.8300282958650456, 36.5897835031988, 1.8300282958650456},
    AExt={109.76935050959638, 5.4900848875951365, 109.76935050959638, 5.4900848875951365})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*230.51887079438305)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*76.8396235981277)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=1689.5021312000001)
