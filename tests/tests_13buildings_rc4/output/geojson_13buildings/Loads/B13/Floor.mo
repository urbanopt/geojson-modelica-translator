...
model Floor
  "This is the simulation model of Floor within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=88147.93728000001,
    hConvExt=2.7000000000000006,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={9.35532944834811e-06},
    CExt={1210010815.616217},
    hRad=5.0,
    AInt=108715.78931200001,
    hConvInt=2.5783783783783782,
    nInt=1,
    RInt={8.335127269944494e-07},
    CInt={8437849801.927211},
    RWin=0.0001699803288744139,
    RExtRem=0.0003839602648638374,
    AFloor=844.7510656,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={3.099416685710362e-05},
    RFloorRem=0.0009752194203329544,
    CFloor={75238269.1777723},
    ARoof=844.7510656,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={2.768839776192413e-05},
    RRoofRem=0.0013753363908068485,
    CRoof={306482220.19309586},
    ...
    nOrientations=4,
    AWin={457.372293789985, 22.87535369831307, 457.372293789985, 22.87535369831307},
    ATransparent={457.372293789985, 22.87535369831307, 457.372293789985, 22.87535369831307},
    AExt={1372.1168813699549, 68.6260610949392, 1372.1168813699549, 68.6260610949392})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*2881.485884929788)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*960.4952949765961)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=21118.77664)
