...
model Office
  "This is the simulation model of Office within building B13 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=176295.87456000003,
    hConvExt=2.7000000000000006,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={4.677664724174055e-06},
    CExt={2420021631.232434},
    hRad=5.0,
    AInt=114592.31846400001,
    hConvInt=2.4692307692307693,
    nInt=1,
    RInt={6.379015477452224e-07},
    CInt={10936843716.988707},
    RWin=8.499016443720694e-05,
    RExtRem=0.0001919801324319187,
    AFloor=1689.5021312,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={1.549708342855181e-05},
    RFloorRem=0.0004876097101664772,
    CFloor={150476538.3555446},
    ARoof=1689.5021312,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={1.3844198880962065e-05},
    RRoofRem=0.0006876681954034242,
    CRoof={612964440.3861917},
    ...
    nOrientations=4,
    AWin={914.74458757997, 45.75070739662614, 914.74458757997, 45.75070739662614},
    ATransparent={914.74458757997, 45.75070739662614, 914.74458757997, 45.75070739662614},
    AExt={2744.2337627399097, 137.2521221898784, 2744.2337627399097, 137.2521221898784})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4761837941133585, 0.0238162058866415, 0.4761837941133585, 0.0238162058866415},
    wfWin={0.4761837941133584, 0.023816205886641493, 0.4761837941133584, 0.023816205886641493},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*5762.971769859576)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*1920.9905899531923)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B13/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=42237.55328)
