within geojson_13buildings.Loads.B12;
model Restroom
  "This is the simulation model of Restroom within building B12 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    VAir=16702.11591552,
    hConvExt=2.700000000000001,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.953658388356779e-05},
    CExt={228518983.92430687},
    hRad=5.0,
    AInt=15774.220586880001,
    hConvInt=2.5823529411764716,
    nInt=1,
    RInt={5.79511544492659e-06},
    CInt={1214057544.081578},
    RWin=0.0009000479209559666,
    RExtRem=0.0020330742998839876,
    AFloor=533.5398139680002,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={4.9072917886298185e-05},
    RFloorRem=0.0015440602986930738,
    CFloor={47520049.13053402},
    ARoof=533.5398139680002,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={4.383890930311134e-05},
    RRoofRem=0.002177563606831832,
    CRoof={193572371.086837},
    ...
    nOrientations=4,
    AWin={89.56334254170783, 1.1347760368231072, 89.56334254170783, 1.1347760368231072},
    ATransparent={89.56334254170783, 1.1347760368231072, 89.56334254170783, 1.1347760368231072},
    AExt={268.6900276251235, 3.4043281104693213, 268.6900276251235, 3.4043281104693213})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.4937442140222536, 0.006255785977746395, 0.4937442140222536, 0.006255785977746395},
    wfWin={0.49374421402225355, 0.006255785977746395, 0.49374421402225355, 0.006255785977746395},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=4.999999999999998,
    hConvWinOut=19.999999999999996,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*544.1887114711856)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*181.39623715706188)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_Restroom.txt"),
    columns={2,3,4})
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007 eqAirTempVDI(
    aExt=0.5,
    wfGro=0,
    hConvWallOut=20.000000000000007,
    hRad=5.0,
    n=1,
    wfWall={1.0},
    wfWin={0},
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=13338.49534920001)
