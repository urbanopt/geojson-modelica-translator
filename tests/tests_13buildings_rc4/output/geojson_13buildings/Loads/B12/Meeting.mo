...
model Meeting
  "This is the simulation model of Meeting within building B12 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    hRad=5.0,
    AInt=10206.848615039999,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={7.841696663472451e-06},
    CInt={892547662.091677},
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_Meeting.txt"),
    columns={2,3,4})
