...
model Storage
  "This is the simulation model of Storage within building B12 with traceable ID None"
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=4,  UWin=3.001782134105592)
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.3209755702284744e-05},
    CExt={856946189.7161505},
    hRad=5.0,
    AInt=38275.6823064,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={2.0911191102593202e-06},
    CInt={3347053732.8437886},
    RWin=0.00024001277892159105,
    RExtRem=0.0005421531466357302,
    AFloor=2000.7743023800006,
    hConvFloor=1.7000000000000002,
    nFloor=1,
    RFloor={1.3086111436346184e-05},
    RFloorRem=0.00041174941298481967,
    CFloor={178200184.23950252},
    ARoof=2000.7743023800006,
    hConvRoof=1.7000000000000002,
    nRoof=1,
    RRoof={1.1690375814163026e-05},
    RRoofRem=0.0005806836284884886,
    CRoof={725896391.5756384},
    ...
    nOrientations=4,
    AWin={335.8625345314043, 4.255410138086652, 335.8625345314043, 4.255410138086652},
    ATransparent={335.8625345314043, 4.255410138086652, 335.8625345314043, 4.255410138086652},
    AExt={1007.587603594213, 12.766230414259953, 1007.587603594213, 12.766230414259953})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.49374421402225355, 0.006255785977746393, 0.49374421402225355, 0.006255785977746393},
    wfWin={0.4937442140222536, 0.006255785977746396, 0.4937442140222536, 0.006255785977746396},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*2040.707668016946)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.0*680.2358893389819)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_Storage.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=50019.35755950003)
