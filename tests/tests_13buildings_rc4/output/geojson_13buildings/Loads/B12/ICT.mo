...
model ICT
  "This is the simulation model of ICT within building B12 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={9.907316776713558e-05},
    CExt={114259491.96215343},
    hRad=5.0,
    AInt=5103.424307519999,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={1.5683393326944903e-05},
    CInt={446273831.0458385},
    RWin=0.0018000958419119332,
    RExtRem=0.004066148599767975,
    AFloor=266.7699069840001,
    hConvFloor=1.7000000000000006,
    nFloor=1,
    RFloor={9.814583577259637e-05},
    RFloorRem=0.0030881205973861477,
    CFloor={23760024.56526701},
    ARoof=266.7699069840001,
    hConvRoof=1.7000000000000006,
    nRoof=1,
    RRoof={8.767781860622268e-05},
    RRoofRem=0.004355127213663664,
    CRoof={96786185.5434185},
    ...
    nOrientations=4,
    AWin={44.78167127085391, 0.5673880184115536, 44.78167127085391, 0.5673880184115536},
    ATransparent={44.78167127085391, 0.5673880184115536, 44.78167127085391, 0.5673880184115536},
    AExt={134.34501381256175, 1.7021640552346606, 134.34501381256175, 1.7021640552346606})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*272.0943557355928)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=24.999999999999996*90.69811857853094)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_ICT.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=6669.247674600005)
