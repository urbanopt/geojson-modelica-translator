...
model Floor
  "This is the simulation model of Floor within building B12 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={7.92585342137085e-06},
    CExt={1428243649.5269177},
    hRad=5.000000000000001,
    AInt=124685.934786,
    hConvInt=2.606976744186047,
    nInt=1,
    RInt={7.754207120247105e-07},
    CInt={9094938927.727028},
    RWin=0.0001440076673529547,
    RExtRem=0.0003252918879814382,
    AFloor=3334.623837300001,
    hConvFloor=1.7,
    nFloor=1,
    RFloor={7.85166686180771e-06},
    RFloorRem=0.00024704964779089184,
    CFloor={297000307.0658375},
    ARoof=3334.623837300001,
    hConvRoof=1.7,
    nRoof=1,
    RRoof={7.014225488497816e-06},
    RRoofRem=0.0003484101770930932,
    CRoof={1209827319.2927306},
    ...
    nOrientations=4,
    AWin={559.7708908856739, 7.09235023014442, 559.7708908856739, 7.09235023014442},
    ATransparent={559.7708908856739, 7.09235023014442, 559.7708908856739, 7.09235023014442},
    AExt={1679.3126726570217, 21.277050690433256, 1679.3126726570217, 21.277050690433256})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*3401.17944669491)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*1133.7264822316365)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_Floor.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=83365.59593250003)
