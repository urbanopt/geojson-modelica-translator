...
model Office
  "This is the simulation model of Office within building B12 with traceable ID None"
  ...
  thermalZoneFourElements(
    ...
    nExt=1,
    RExt={3.962926710685425e-06},
    CExt={2856487299.0538354},
    hRad=5.000000000000001,
    AInt=127585.60768800002,
    hConvInt=2.5181818181818185,
    nInt=1,
    RInt={6.273357330777962e-07},
    CInt={11156845776.14596},
    RWin=7.200383367647735e-05,
    RExtRem=0.0001626459439907191,
    AFloor=6669.247674600002,
    hConvFloor=1.7,
    nFloor=1,
    RFloor={3.925833430903855e-06},
    RFloorRem=0.00012352482389544592,
    CFloor={594000614.131675},
    ARoof=6669.247674600002,
    hConvRoof=1.7,
    nRoof=1,
    RRoof={3.507112744248908e-06},
    RRoofRem=0.0001742050885465466,
    CRoof={2419654638.585461},
    ...
    nOrientations=4,
    AWin={1119.5417817713478, 14.18470046028884, 1119.5417817713478, 14.18470046028884},
    ATransparent={1119.5417817713478, 14.18470046028884, 1119.5417817713478, 14.18470046028884},
    AExt={3358.6253453140434, 42.55410138086651, 3358.6253453140434, 42.55410138086651})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=4,
    wfGro=0.0,
    wfWall={0.49374421402225355, 0.006255785977746392, 0.49374421402225355, 0.006255785977746392},
    wfWin={0.4937442140222536, 0.006255785977746395, 0.4937442140222536, 0.006255785977746395},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*6802.35889338982)
    ...
    rotation=90,
    origin={30,-16})));
  Modelica.Blocks.Sources.Constant hConvWin(k=25.000000000000004*2267.452964463273)
  ...
  Modelica.Blocks.Sources.CombiTimeTable internalGains(
    ...
    fileName=Modelica.Utilities.Files.loadResource(
      "modelica://Loads/Resources/Data/B12/InternalGains_Office.txt"),
    columns={2,3,4})
  ...
  Modelica.Thermal.HeatTransfer.Components.Convection thermalConductorRoof
    ...
    origin={67,27})));
  Modelica.Blocks.Sources.Constant hConvRoof(k=166731.19186500006)
