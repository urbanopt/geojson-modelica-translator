...
from geojson_modelica_translator.modelica.modelica_project import ModelicaProject


class ModelicaPackageTest(unittest.TestCase):
    def setUp(self):
    ...
    def test_load_package_files(self):
        ...
        package = ModelicaProject(package_file)
