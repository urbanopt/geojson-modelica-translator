...
# from geojson_modelica_translator.model_connectors.load_connectors.teaser import Teaser
...
#         filename = Path(self.data_dir) / "teaser_geojson_ex1.json"
#         self.gj = UrbanOptGeoJson(filename)

#         # load system parameter data
#         filename = Path(self.data_dir) / "teaser_system_params_ex1.json"
