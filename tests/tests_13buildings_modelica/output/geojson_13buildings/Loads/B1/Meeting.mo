...
model Meeting
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={9.830770515185385e-06},
    CExt={936754675.8784242},
    hRad=5.0,
    ...
    RExtRem=0.0003107877402500452,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={178.98834003677925, 0.0, 178.98834003677925, 1.12882544889855, 0.0, 1.12882544889855},
    ATransparent={178.98834003677925, 0.0, 178.98834003677925, 1.12882544889855, 0.0, 1.12882544889855},
    AExt={536.9650201103376, 1071.876240768, 536.9650201103376, 3.3864763466956496, 1071.876240768, 3.3864763466956496})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3999845200389461,
    wfWall={0.1536413405099354, 0.290794859797942, 0.1536413405099354, 0.0009689695716205025, 0.0, 0.0009689695716205025},
    wfWin={0.49686641346521654, 0.0, 0.49686641346521654, 0.0031335865347834097, 0.0, 0.0031335865347834097},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*3224.4554744500665)
