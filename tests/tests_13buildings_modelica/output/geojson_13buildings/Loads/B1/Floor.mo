...
model Floor
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.001782134105591)
  ...
  thermalZoneTwoElements(
    ...
    RExtRem=4.972603844000724e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1118.6771252298704, 0.0, 1118.6771252298704, 7.055159055615938, 0.0, 7.055159055615938},
    ATransparent={1118.6771252298704, 0.0, 1118.6771252298704, 7.055159055615938, 0.0, 7.055159055615938},
    AExt={3356.0313756896107, 6699.226504799999, 3356.0313756896107, 21.16547716684781, 6699.226504799999, 21.16547716684781})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.399984520038946,
    wfWall={0.15364134050993544, 0.290794859797942, 0.15364134050993544, 0.0009689695716205025, 0.0, 0.0009689695716205025},
    wfWin={0.4968664134652166, 0.0, 0.4968664134652166, 0.0031335865347834097, 0.0, 0.0031335865347834097},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*20152.846715312917)
