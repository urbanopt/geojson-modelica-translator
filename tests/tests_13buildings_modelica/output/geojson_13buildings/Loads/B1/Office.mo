...
model Office
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={7.864616412148314e-07},
    CExt={11709433448.4803},
    hRad=5.0,
    AInt=256318.231488,
    ...
    RExtRem=2.486301922000362e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={2237.354250459741, 0.0, 2237.354250459741, 14.110318111231877, 0.0, 14.110318111231877},
    ATransparent={2237.354250459741, 0.0, 2237.354250459741, 14.110318111231877, 0.0, 14.110318111231877},
    AExt={6712.0627513792215, 13398.453009599998, 6712.0627513792215, 42.33095433369562, 13398.453009599998, 42.33095433369562})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*40305.69343062583)
