...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={2.621538804049438e-06},
    CExt={3512830034.544089},
    ...
    RExtRem=8.287673073334541e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={671.2062751379223, 0.0, 671.2062751379223, 4.233095433369563, 0.0, 4.233095433369563},
    ATransparent={671.2062751379223, 0.0, 671.2062751379223, 4.233095433369563, 0.0, 4.233095433369563},
    AExt={2013.6188254137664, 4019.53590288, 2013.6188254137664, 12.699286300108687, 4019.53590288, 12.699286300108687})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.15364134050993541, 0.29079485979794206, 0.15364134050993541, 0.0009689695716205023, 0.0, 0.0009689695716205023},
    wfWin={0.4968664134652166, 0.0, 0.4968664134652166, 0.00313358653478341, 0.0, 0.00313358653478341},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*12091.70802918775)
