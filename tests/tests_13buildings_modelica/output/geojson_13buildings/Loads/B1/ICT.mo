...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.966154103037077e-05},
    CExt={468377337.9392121},
    hRad=5.0,
    ...
    RExtRem=0.0006215754805000904,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={89.49417001838962, 0.0, 89.49417001838962, 0.564412724449275, 0.0, 0.564412724449275},
    ATransparent={89.49417001838962, 0.0, 89.49417001838962, 0.564412724449275, 0.0, 0.564412724449275},
    AExt={268.4825100551688, 535.938120384, 268.4825100551688, 1.6932381733478248, 535.938120384, 1.6932381733478248})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1612.2277372250333)
