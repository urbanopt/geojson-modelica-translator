...
model Meeting
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.0017821341055915)
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.0523714533473933,
    hConvWin=2.7000000000000006,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00022088158751594928},
    CExt={42042663.70222422},
    ...
    RExtRem=0.007021451732311723,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={7.332506921170992, 0.0, 7.332506921170992, 1.069912585313914, 0.0, 1.069912585313914},
    ATransparent={7.332506921170992, 0.0, 7.332506921170992, 1.069912585313914, 0.0, 1.069912585313914},
    AExt={21.997520763512973, 46.32878187200001, 21.997520763512973, 3.2097377559417413, 46.32878187200001, 3.2097377559417413})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3904109246785299,
    wfWall={0.1421374009666215, 0.28383470963932245, 0.1421374009666215, 0.02073978187445233, 0.0, 0.02073978187445233},
    wfWin={0.4363330654647649, 0.0, 0.4363330654647649, 0.06366693453523511, 0.0, 0.06366693453523511},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*143.07208078290944)
