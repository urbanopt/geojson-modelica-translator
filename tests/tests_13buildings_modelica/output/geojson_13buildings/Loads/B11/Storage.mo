...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={5.8901756670919794e-05},
    CExt={157659988.88334087},
    hRad=5.0,
    AInt=3323.5865256,
    ...
    RExtRem=0.0018723871286164594,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={27.49690095439122, 0.0, 27.49690095439122, 4.012172194927177, 0.0, 4.012172194927177},
    ATransparent={27.49690095439122, 0.0, 27.49690095439122, 4.012172194927177, 0.0, 4.012172194927177},
    AExt={82.49070286317365, 173.73293202000002, 82.49070286317365, 12.036516584781529, 173.73293202000002, 12.036516584781529})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.39041092467852984,
    wfWall={0.14213740096662147, 0.28383470963932245, 0.14213740096662147, 0.020739781874452325, 0.0, 0.020739781874452325},
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*536.5203029359104)
