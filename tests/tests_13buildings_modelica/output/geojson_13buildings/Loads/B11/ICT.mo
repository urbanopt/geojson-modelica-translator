...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00044176317503189855},
    CExt={21021331.85111211},
    ...
    RExtRem=0.014042903464623446,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={3.666253460585496, 0.0, 3.666253460585496, 0.534956292656957, 0.0, 0.534956292656957},
    ATransparent={3.666253460585496, 0.0, 3.666253460585496, 0.534956292656957, 0.0, 0.534956292656957},
    AExt={10.998760381756487, 23.164390936000004, 10.998760381756487, 1.6048688779708706, 23.164390936000004, 1.6048688779708706})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*71.53604039145472)
