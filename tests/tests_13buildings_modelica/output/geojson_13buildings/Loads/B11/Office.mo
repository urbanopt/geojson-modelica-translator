...
model Office
  ...
  thermalZoneTwoElements(
    ...
    VAir=18128.653776,
    hConvExt=2.052371453347394,
    hConvWin=2.7000000000000006,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.7670527001275943e-05},
    CExt={525533296.2778028},
    hRad=5.0,
    ...
    RExtRem=0.0005617161385849379,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={91.6563365146374, 0.0, 91.6563365146374, 13.373907316423924, 0.0, 13.373907316423924},
    ATransparent={91.6563365146374, 0.0, 91.6563365146374, 13.373907316423924, 0.0, 13.373907316423924},
    AExt={274.96900954391214, 579.1097734000001, 274.96900954391214, 40.121721949271766, 579.1097734000001, 40.121721949271766})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.39041092467852995,
    wfWall={0.14213740096662147, 0.2838347096393225, 0.14213740096662147, 0.020739781874452325, 0.0, 0.020739781874452325},
    wfWin={0.43633306546476486, 0.0, 0.43633306546476486, 0.0636669345352351, 0.0, 0.0636669345352351},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*1788.401009786368)
