...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={3.534105400255189e-05},
    CExt={262766648.1389014},
    ...
    RExtRem=0.0011234322771698758,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={45.8281682573187, 0.0, 45.8281682573187, 6.686953658211962, 0.0, 6.686953658211962},
    ATransparent={45.8281682573187, 0.0, 45.8281682573187, 6.686953658211962, 0.0, 6.686953658211962},
    AExt={137.48450477195607, 289.55488670000005, 137.48450477195607, 20.060860974635883, 289.55488670000005, 20.060860974635883})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*894.200504893184)
