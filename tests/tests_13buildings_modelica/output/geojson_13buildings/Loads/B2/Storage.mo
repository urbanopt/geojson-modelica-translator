...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={3.8254463527844055e-05},
    CExt={216499678.74808255},
    ...
    RExtRem=0.0011541469035192622,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={20.460419665835087, 0.0, 20.460419665835087, 1.4499781566274306, 0.0, 1.4499781566274306},
    ATransparent={20.460419665835087, 0.0, 20.460419665835087, 1.4499781566274306, 0.0, 1.4499781566274306},
    AExt={61.38125899750526, 357.70996697999993, 61.38125899750526, 4.3499344698822915, 357.70996697999993, 4.3499344698822915})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.06549818667607958, 0.36191327574494103, 0.06549818667607958, 0.0046416907145655556, 0.0, 0.0046416907145655556},
    wfWin={0.46691118599542464, 0.0, 0.46691118599542464, 0.03308881400457536, 0.0, 0.03308881400457536},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*846.8823208947749)
