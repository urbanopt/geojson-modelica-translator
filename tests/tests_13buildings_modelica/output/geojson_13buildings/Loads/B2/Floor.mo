...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={2.295267811670646e-05},
    CExt={360832797.9134706},
    hRad=5.0,
    AInt=6739.463146,
    ...
    RExtRem=0.0006924881421115571,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={34.10069944305848, 0.0, 34.10069944305848, 2.416630261045718, 0.0, 2.416630261045718},
    ATransparent={34.10069944305848, 0.0, 34.10069944305848, 2.416630261045718, 0.0, 2.416630261045718},
    AExt={102.30209832917545, 596.1832783, 102.30209832917545, 7.249890783137153, 596.1832783, 7.249890783137153})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1411.4705348246252)
