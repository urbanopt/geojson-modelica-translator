...
model Office
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.00178213410559)
  ...
  thermalZoneTwoElements(
    ...
    VAir=12442.085808,
    hConvExt=1.8552309969062513,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={1.147633905835323e-05},
    CExt={721665595.8269413},
    hRad=5.0,
    AInt=6221.042904,
    ...
    RExtRem=0.00034624407105577856,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={68.20139888611696, 0.0, 68.20139888611696, 4.833260522091436, 0.0, 4.833260522091436},
    ATransparent={68.20139888611696, 0.0, 68.20139888611696, 4.833260522091436, 0.0, 4.833260522091436},
    AExt={204.6041966583509, 1192.3665566, 204.6041966583509, 14.499781566274306, 1192.3665566, 14.499781566274306})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.49780696947376857,
    wfWall={0.0654981866760796, 0.361913275744941, 0.0654981866760796, 0.004641690714565555, 0.0, 0.004641690714565555},
    wfWin={0.46691118599542464, 0.0, 0.46691118599542464, 0.033088814004575376, 0.0, 0.033088814004575376},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*2822.9410696492505)
