...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0002869084764588313},
    CExt={28866623.833077602},
    ...
    RExtRem=0.008656101776394464,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={2.7280559554446784, 0.0, 2.7280559554446784, 0.19333042088365743, 0.0, 0.19333042088365743},
    ATransparent={2.7280559554446784, 0.0, 2.7280559554446784, 0.19333042088365743, 0.0, 0.19333042088365743},
    AExt={8.184167866334036, 47.694662263999994, 8.184167866334036, 0.5799912626509722, 47.694662263999994, 0.5799912626509722})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*112.91764278597)
