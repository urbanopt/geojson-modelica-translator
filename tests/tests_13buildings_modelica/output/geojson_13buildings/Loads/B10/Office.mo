...
model Office
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={7.556166466764104e-07},
    CExt={13421991215.66187},
    hRad=5.0,
    AInt=460380.594768,
    ...
    RExtRem=2.5999697062340777e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={3764.062416206663, 0.0, 3764.062416206663, 37.24691988327082, 0.0, 37.24691988327082},
    ATransparent={3764.062416206663, 0.0, 3764.062416206663, 37.24691988327082, 0.0, 37.24691988327082},
    AExt={11292.187248619988, 8539.3174836, 11292.187248619988, 111.74075964981247, 8539.3174836, 111.74075964981247})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*39886.4909837396)
