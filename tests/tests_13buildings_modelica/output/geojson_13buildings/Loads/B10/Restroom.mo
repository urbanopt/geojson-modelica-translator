...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    RExtRem=0.00032499621327925974,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={301.12499329653303, 0.0, 301.12499329653303, 2.979753590661666, 0.0, 2.979753590661666},
    ATransparent={301.12499329653303, 0.0, 301.12499329653303, 2.979753590661666, 0.0, 2.979753590661666},
    AExt={903.3749798895991, 683.145398688, 903.3749798895991, 8.939260771984998, 683.145398688, 8.939260771984998})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.26490127629559196,
    wfWall={0.26859783917603447, 0.19258727686054464, 0.26859783917603447, 0.002657884245897194, 0.0, 0.002657884245897194},
    wfWin={0.495100777575552, 0.0, 0.495100777575552, 0.004899222424448018, 0.0, 0.004899222424448018},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=4.999999999999999,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*3190.919278699168)
