...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={1.8890416166910256e-05},
    CExt={536879648.626475},
    ...
    RExtRem=0.0006499924265585195,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={150.56249664826652, 0.0, 150.56249664826652, 1.489876795330833, 0.0, 1.489876795330833},
    ATransparent={150.56249664826652, 0.0, 150.56249664826652, 1.489876795330833, 0.0, 1.489876795330833},
    AExt={451.68748994479955, 341.572699344, 451.68748994479955, 4.469630385992499, 341.572699344, 4.469630385992499})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1595.459639349584)
