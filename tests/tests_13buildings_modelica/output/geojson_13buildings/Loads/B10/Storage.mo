...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    VAir=213854.2117632,
    hConvExt=2.271819065904735,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={2.5187221555880307e-06},
    CExt={4026597364.6985626},
    ...
    RExtRem=8.666565687446927e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1129.2187248619987, 0.0, 1129.2187248619987, 11.174075964981245, 0.0, 11.174075964981245},
    ATransparent={1129.2187248619987, 0.0, 1129.2187248619987, 11.174075964981245, 0.0, 11.174075964981245},
    AExt={3387.6561745859963, 2561.79524508, 3387.6561745859963, 33.52222789494374, 2561.79524508, 33.52222789494374})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.264901276295592,
    wfWall={0.26859783917603447, 0.19258727686054464, 0.26859783917603447, 0.002657884245897194, 0.0, 0.002657884245897194},
    wfWin={0.495100777575552, 0.0, 0.495100777575552, 0.004899222424448019, 0.0, 0.004899222424448019},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*11965.947295121881)
