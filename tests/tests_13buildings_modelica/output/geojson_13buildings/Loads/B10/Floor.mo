...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.5112332933528208e-06},
    CExt={6710995607.830935},
    hRad=5.0,
    AInt=438104.114376,
    ...
    RExtRem=5.1999394124681555e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1882.0312081033314, 0.0, 1882.0312081033314, 18.62345994163541, 0.0, 18.62345994163541},
    ATransparent={1882.0312081033314, 0.0, 1882.0312081033314, 18.62345994163541, 0.0, 18.62345994163541},
    AExt={5646.093624309994, 4269.6587418, 5646.093624309994, 55.87037982490624, 4269.6587418, 55.87037982490624})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.26859783917603447, 0.19258727686054466, 0.26859783917603447, 0.0026578842458971946, 0.0, 0.0026578842458971946},
    wfWin={0.495100777575552, 0.0, 0.495100777575552, 0.0048992224244480175, 0.0, 0.0048992224244480175},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*19943.2454918698)
