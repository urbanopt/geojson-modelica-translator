...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0013218807671755454},
    CExt={7056587.182286636},
    ...
    RExtRem=0.042149106055519706,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.9966356137354102, 0.0, 0.9966356137354102, 0.44230868565545767, 0.0, 0.44230868565545767},
    ATransparent={0.9966356137354102, 0.0, 0.9966356137354102, 0.44230868565545767, 0.0, 0.44230868565545767},
    AExt={2.98990684120623, 7.616012264, 2.98990684120623, 1.3269260569663728, 7.616012264, 1.3269260569663728})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*23.865690324345202)
