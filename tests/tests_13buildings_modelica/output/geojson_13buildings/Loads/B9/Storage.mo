...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.0617605725629513,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.00017625076895673916},
    CExt={52924403.867149815},
    ...
    RExtRem=0.005619880807402627,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={7.4747671030155765, 0.0, 7.4747671030155765, 3.317315142415932, 0.0, 3.317315142415932},
    ATransparent={7.4747671030155765, 0.0, 7.4747671030155765, 3.317315142415932, 0.0, 3.317315142415932},
    AExt={22.424301309046726, 57.12009198, 22.424301309046726, 9.951945427247795, 57.12009198, 9.951945427247795})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3851726746925958,
    wfWall={0.11594420439147472, 0.2800264218333395, 0.11594420439147472, 0.051456247345557656, 0.0, 0.051456247345557656},
    wfWin={0.34630791968712926, 0.0, 0.34630791968712926, 0.15369208031287077, 0.0, 0.15369208031287077},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*178.99267743258903)
