...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00010575046137404348},
    CExt={88207339.77858305},
    ...
    RExtRem=0.0033719284844415756,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={12.457945171692627, 0.0, 12.457945171692627, 5.52885857069322, 0.0, 5.52885857069322},
    ATransparent={12.457945171692627, 0.0, 12.457945171692627, 5.52885857069322, 0.0, 5.52885857069322},
    AExt={37.37383551507788, 95.2001533, 37.37383551507788, 16.58657571207966, 95.2001533, 16.58657571207966})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*298.32112905431507)
