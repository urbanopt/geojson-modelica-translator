...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    VAir=476.82859392,
    hConvExt=2.0617605725629518,
    hConvWin=2.7,
    gWin=0.7800000000000001,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0006609403835877727},
    CExt={14113174.364573272},
    hRad=5.0,
    AInt=450.33811648,
    ...
    RExtRem=0.021074553027759853,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1.9932712274708204, 0.0, 1.9932712274708204, 0.8846173713109153, 0.0, 0.8846173713109153},
    ATransparent={1.9932712274708204, 0.0, 1.9932712274708204, 0.8846173713109153, 0.0, 0.8846173713109153},
    AExt={5.97981368241246, 15.232024528, 5.97981368241246, 2.6538521139327456, 15.232024528, 2.6538521139327456})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.11594420439147471, 0.2800264218333395, 0.11594420439147471, 0.05145624734555766, 0.0, 0.05145624734555766},
    wfWin={0.34630791968712926, 0.0, 0.34630791968712926, 0.1536920803128708, 0.0, 0.1536920803128708},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*47.731380648690404)
