...
model Office
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.0017821341055924)
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={5.287523068702174e-05},
    CExt={176414679.5571661},
    ...
    RExtRem=0.0016859642422207878,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={24.915890343385254, 0.0, 24.915890343385254, 11.05771714138644, 0.0, 11.05771714138644},
    ATransparent={24.915890343385254, 0.0, 24.915890343385254, 11.05771714138644, 0.0, 11.05771714138644},
    AExt={74.74767103015576, 190.4003066, 74.74767103015576, 33.17315142415932, 190.4003066, 33.17315142415932})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.11594420439147471, 0.2800264218333394, 0.11594420439147471, 0.05145624734555765, 0.0, 0.05145624734555765},
    wfWin={0.3463079196871292, 0.0, 0.3463079196871292, 0.15369208031287074, 0.0, 0.15369208031287074},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*596.6422581086301)
