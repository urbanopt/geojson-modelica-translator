...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={5.806275250459139e-05},
    CExt={159233205.40549713},
    ...
    RExtRem=0.001840293022084985,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={30.05108412151611, 0.0, 30.05108412151611, 1.1347219871913954, 0.0, 1.1347219871913954},
    ATransparent={30.05108412151611, 0.0, 30.05108412151611, 1.1347219871913954, 0.0, 1.1347219871913954},
    AExt={90.15325236454832, 179.026520112, 90.15325236454832, 3.404165961574186, 179.026520112, 3.404165961574186})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.39550318565494547,
    wfWall={0.1527135483013129, 0.2875368612039558, 0.1527135483013129, 0.005766428269236511, 0.0, 0.005766428269236511},
    wfWin={0.4818070762186493, 0.0, 0.4818070762186493, 0.018192923781350737, 0.0, 0.018192923781350737},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*545.167876876245)
