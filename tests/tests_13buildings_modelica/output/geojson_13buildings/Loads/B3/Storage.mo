...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={1.5483400667891037e-05},
    CExt={597124520.2706144},
    ...
    RExtRem=0.0004907448058893294,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={112.69156545568539, 0.0, 112.69156545568539, 4.255207451967732, 0.0, 4.255207451967732},
    ATransparent={112.69156545568539, 0.0, 112.69156545568539, 4.255207451967732, 0.0, 4.255207451967732},
    AExt={338.07469636705616, 671.3494504199998, 338.07469636705616, 12.765622355903195, 671.3494504199998, 12.765622355903195})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3955031856549454,
    wfWall={0.1527135483013129, 0.28753686120395583, 0.1527135483013129, 0.0057664282692365095, 0.0, 0.0057664282692365095},
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*2044.3795382859184)
