...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={9.290040400734611e-06},
    CExt={995207533.7843583},
    ...
    RExtRem=0.0002944468835335976,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={187.81927575947566, 0.0, 187.81927575947566, 7.0920124199462204, 0.0, 7.0920124199462204},
    ATransparent={187.81927575947566, 0.0, 187.81927575947566, 7.0920124199462204, 0.0, 7.0920124199462204},
    AExt={563.457827278427, 1118.9157506999998, 563.457827278427, 21.27603725983866, 1118.9157506999998, 21.27603725983866})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*3407.299230476531)
