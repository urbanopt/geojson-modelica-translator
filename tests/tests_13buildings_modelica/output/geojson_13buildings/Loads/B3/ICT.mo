...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.00011612550500918278},
    CExt={79616602.70274857},
    hRad=5.0,
    ...
    RExtRem=0.00368058604416997,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={15.025542060758054, 0.0, 15.025542060758054, 0.5673609935956977, 0.0, 0.5673609935956977},
    ATransparent={15.025542060758054, 0.0, 15.025542060758054, 0.5673609935956977, 0.0, 0.5673609935956977},
    AExt={45.07662618227416, 89.513260056, 45.07662618227416, 1.702082980787093, 89.513260056, 1.702082980787093})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*272.5839384381225)
