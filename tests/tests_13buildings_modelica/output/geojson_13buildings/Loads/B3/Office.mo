...
model Office
  ...
  thermalZoneTwoElements(
    ...
    RExtRem=0.0001472234417667988,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={375.6385515189513, 0.0, 375.6385515189513, 14.184024839892441, 0.0, 14.184024839892441},
    ATransparent={375.6385515189513, 0.0, 375.6385515189513, 14.184024839892441, 0.0, 14.184024839892441},
    AExt={1126.915654556854, 2237.8315013999995, 1126.915654556854, 42.55207451967732, 2237.8315013999995, 42.55207451967732})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3955031856549455,
    wfWall={0.15271354830131287, 0.2875368612039558, 0.15271354830131287, 0.0057664282692365095, 0.0, 0.0057664282692365095},
    wfWin={0.48180707621864927, 0.0, 0.48180707621864927, 0.018192923781350734, 0.0, 0.018192923781350734},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*6814.598460953062)
