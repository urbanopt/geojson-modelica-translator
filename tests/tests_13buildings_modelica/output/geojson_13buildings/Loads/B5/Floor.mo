...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={5.783119557549587e-05},
    CExt={143686476.80127418},
    hRad=5.0,
    ...
    RExtRem=0.0017463488765784255,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={12.657442547863454, 0.0, 12.657442547863454, 2.2733736338823785, 0.0, 2.2733736338823785},
    ATransparent={12.657442547863454, 0.0, 12.657442547863454, 2.2733736338823785, 0.0, 2.2733736338823785},
    AExt={37.97232764359036, 235.23495640000002, 37.97232764359036, 6.820120901647135, 235.23495640000002, 6.820120901647135})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.4952887006820358,
    wfWall={0.0613037912589556, 0.36008245584182524, 0.0613037912589556, 0.011010630479113919, 0.0, 0.011010630479113919},
    wfWin={0.4238697467636844, 0.0, 0.4238697467636844, 0.07613025323631563, 0.0, 0.07613025323631563},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*560.054809890475)
