...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    RExtRem=0.010914680478615157,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={2.025190807658153, 0.0, 2.025190807658153, 0.3637397814211806, 0.0, 0.3637397814211806},
    ATransparent={2.025190807658153, 0.0, 2.025190807658153, 0.3637397814211806, 0.0, 0.3637397814211806},
    AExt={6.075572422974458, 37.637593024000005, 6.075572422974458, 1.0912193442635418, 37.637593024000005, 1.0912193442635418})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.06130379125895561, 0.36008245584182524, 0.06130379125895561, 0.01101063047911392, 0.0, 0.01101063047911392},
    wfWin={0.42386974676368433, 0.0, 0.42386974676368433, 0.0761302532363156, 0.0, 0.0761302532363156},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*89.60876958247601)
