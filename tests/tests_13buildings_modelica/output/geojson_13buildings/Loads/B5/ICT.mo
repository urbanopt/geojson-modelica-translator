...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.0007228899446936974},
    CExt={11494918.144101946},
    ...
    RExtRem=0.021829360957230315,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1.0125954038290765, 0.0, 1.0125954038290765, 0.1818698907105903, 0.0, 0.1818698907105903},
    ATransparent={1.0125954038290765, 0.0, 1.0125954038290765, 0.1818698907105903, 0.0, 0.1818698907105903},
    AExt={3.037786211487229, 18.818796512000002, 3.037786211487229, 0.5456096721317709, 18.818796512000002, 0.5456096721317709})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*44.80438479123801)
