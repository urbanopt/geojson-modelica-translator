...
model Office
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={2.8915597787747935e-05},
    CExt={287372953.60254836},
    hRad=5.0,
    AInt=2454.625632,
    hConvInt=2.7,
    nInt=1,
    ...
    RExtRem=0.0008731744382892128,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={25.314885095726908, 0.0, 25.314885095726908, 4.546747267764757, 0.0, 4.546747267764757},
    ATransparent={25.314885095726908, 0.0, 25.314885095726908, 4.546747267764757, 0.0, 4.546747267764757},
    AExt={75.94465528718072, 470.46991280000003, 75.94465528718072, 13.64024180329427, 470.46991280000003, 13.64024180329427})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1120.10961978095)
