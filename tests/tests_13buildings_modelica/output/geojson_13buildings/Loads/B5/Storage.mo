...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    VAir=1472.7753792,
    hConvExt=1.859957374721939,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={9.638532595915978e-05},
    CExt={86211886.0807645},
    hRad=5.0,
    ...
    RExtRem=0.0029105814609640423,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={7.594465528718072, 0.0, 7.594465528718072, 1.3640241803294268, 0.0, 1.3640241803294268},
    ATransparent={7.594465528718072, 0.0, 7.594465528718072, 1.3640241803294268, 0.0, 1.3640241803294268},
    AExt={22.783396586154215, 141.14097384, 22.783396586154215, 4.092072540988281, 141.14097384, 4.092072540988281})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.4952887006820357,
    wfWall={0.0613037912589556, 0.36008245584182513, 0.0613037912589556, 0.011010630479113917, 0.0, 0.011010630479113917},
    wfWin={0.42386974676368444, 0.0, 0.42386974676368444, 0.07613025323631561, 0.0, 0.07613025323631561},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*336.032885934285)
