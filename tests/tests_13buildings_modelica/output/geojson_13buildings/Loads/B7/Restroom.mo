...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    VAir=476.82859392,
    hConvExt=2.2313130367434373,
    hConvWin=2.7,
    gWin=0.7799999999999999,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={0.0009363453572927376},
    CExt={10680124.720975902},
    ...
    RExtRem=0.03172013984158781,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1.5246254983820506, 0.0, 1.5246254983820506, 1.353263100399685, 0.0, 1.353263100399685},
    ATransparent={1.5246254983820506, 0.0, 1.5246254983820506, 1.353263100399685, 0.0, 1.353263100399685},
    AExt={4.573876495146152, 7.616012264, 4.573876495146152, 4.0597893011990545, 7.616012264, 4.0597893011990545})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.28856189240666014,
    wfWall={0.13287991127763177, 0.2097889064238114, 0.13287991127763177, 0.11794468930713249, 0.0, 0.11794468930713249},
    wfWin={0.26488612155235153, 0.0, 0.26488612155235153, 0.23511387844764853, 0.0, 0.23511387844764853},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000007*32.49935612069041)
