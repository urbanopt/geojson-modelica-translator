...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00014981525716683787},
    CExt={66750779.50609942},
    hRad=5.0,
    AInt=3642.440648,
    ...
    RExtRem=0.00507522237465405,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={9.528909364887816, 0.0, 9.528909364887816, 8.45789437749803, 0.0, 8.45789437749803},
    ATransparent={9.528909364887816, 0.0, 9.528909364887816, 8.45789437749803, 0.0, 8.45789437749803},
    AExt={28.58672809466345, 47.60007665, 28.58672809466345, 25.37368313249409, 47.60007665, 25.37368313249409})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*203.12097575431508)
