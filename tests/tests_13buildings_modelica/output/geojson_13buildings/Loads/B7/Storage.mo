...
model Storage
  ...
  Buildings.ThermalZones.ReducedOrder.SolarGain.CorrectionGDoublePane corGDoublePane(n=6,  UWin=3.0017821341055906)
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.2313130367434364,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={0.0002496920952780632},
    CExt={40050467.703659646},
    hRad=5.0,
    ...
    RExtRem=0.008458703957756749,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={5.71734561893269, 0.0, 5.71734561893269, 5.074736626498818, 0.0, 5.074736626498818},
    ATransparent={5.71734561893269, 0.0, 5.71734561893269, 5.074736626498818, 0.0, 5.074736626498818},
    AExt={17.15203685679807, 28.56004599, 17.15203685679807, 15.224209879496454, 28.56004599, 15.224209879496454})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.2885618924066601,
    wfWall={0.13287991127763174, 0.20978890642381134, 0.13287991127763174, 0.11794468930713248, 0.0, 0.11794468930713248},
    wfWin={0.26488612155235153, 0.0, 0.26488612155235153, 0.23511387844764847, 0.0, 0.23511387844764847},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.99999999999999*121.87258545258905)
