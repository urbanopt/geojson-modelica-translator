...
model Office
  ...
  thermalZoneTwoElements(
    ...
    VAir=5960.357424,
    hConvExt=2.231313036743437,
    hConvWin=2.700000000000001,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={7.490762858341894e-05},
    CExt={133501559.01219884},
    ...
    RExtRem=0.002537611187327025,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={19.057818729775633, 0.0, 19.057818729775633, 16.91578875499606, 0.0, 16.91578875499606},
    ATransparent={19.057818729775633, 0.0, 19.057818729775633, 16.91578875499606, 0.0, 16.91578875499606},
    AExt={57.1734561893269, 95.2001533, 57.1734561893269, 50.74736626498818, 95.2001533, 50.74736626498818})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.13287991127763177, 0.20978890642381137, 0.13287991127763177, 0.11794468930713248, 0.0, 0.11794468930713248},
    wfWin={0.26488612155235153, 0.0, 0.26488612155235153, 0.23511387844764844, 0.0, 0.23511387844764844},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=4.999999999999999,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*406.24195150863017)
