...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.0018726907145854752},
    CExt={5340062.360487951},
    ...
    RExtRem=0.06344027968317562,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.7623127491910253, 0.0, 0.7623127491910253, 0.6766315501998424, 0.0, 0.6766315501998424},
    ATransparent={0.7623127491910253, 0.0, 0.7623127491910253, 0.6766315501998424, 0.0, 0.6766315501998424},
    AExt={2.286938247573076, 3.808006132, 2.286938247573076, 2.0298946505995272, 3.808006132, 2.0298946505995272})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000007*16.249678060345204)
