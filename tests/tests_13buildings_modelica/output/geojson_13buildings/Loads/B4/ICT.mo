...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.000454000703678268},
    CExt={20456799.106951468},
    hRad=5.0,
    ...
    RExtRem=0.014432912929912781,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={3.556738273500204, 0.0, 3.556738273500204, 0.5335498263596302, 0.0, 0.5335498263596302},
    ATransparent={3.556738273500204, 0.0, 3.556738273500204, 0.5335498263596302, 0.0, 0.5335498263596302},
    AExt={10.670214820500611, 22.531682647999997, 10.670214820500611, 1.6006494790788905, 22.531682647999997, 1.6006494790788905})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*69.605093895159)
