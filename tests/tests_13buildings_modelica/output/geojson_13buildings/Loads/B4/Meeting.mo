...
model Meeting
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.052585238030487,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.000227000351839134},
    CExt={40913598.213902935},
    hRad=5.0,
    ...
    RExtRem=0.007216456464956391,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={7.113476547000408, 0.0, 7.113476547000408, 1.0670996527192604, 0.0, 1.0670996527192604},
    ATransparent={7.113476547000408, 0.0, 7.113476547000408, 1.0670996527192604, 0.0, 1.0670996527192604},
    AExt={21.340429641001222, 45.06336529599999, 21.340429641001222, 3.201298958157781, 45.06336529599999, 3.201298958157781})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.39029178047432644,
    wfWall={0.14172044121093322, 0.2837480899817575, 0.14172044121093322, 0.021259623561024798, 0.0, 0.021259623561024798},
    wfWin={0.4347784540680748, 0.0, 0.4347784540680748, 0.06522154593192518, 0.0, 0.06522154593192518},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*139.210187790318)
