...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={3.6320056294261385e-05},
    CExt={255709988.8368936},
    hRad=5.0,
    ...
    RExtRem=0.0011546330343930225,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={44.45922841875255, 0.0, 44.45922841875255, 6.669372829495378, 0.0, 6.669372829495378},
    ATransparent={44.45922841875255, 0.0, 44.45922841875255, 6.669372829495378, 0.0, 6.669372829495378},
    AExt={133.37768525625765, 281.6460331, 133.37768525625765, 20.008118488486133, 281.6460331, 20.008118488486133})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.14172044121093322, 0.2837480899817575, 0.14172044121093322, 0.021259623561024794, 0.0, 0.021259623561024794},
    wfWin={0.4347784540680748, 0.0, 0.4347784540680748, 0.06522154593192517, 0.0, 0.06522154593192517},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*870.0636736894876)
