...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.0525852380304865,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={6.053342715710231e-05},
    CExt={153425993.30213612},
    hRad=5.0,
    ...
    RExtRem=0.001924388390655038,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={26.675537051251528, 0.0, 26.675537051251528, 4.001623697697227, 0.0, 4.001623697697227},
    ATransparent={26.675537051251528, 0.0, 26.675537051251528, 4.001623697697227, 0.0, 4.001623697697227},
    AExt={80.02661115375457, 168.98761985999997, 80.02661115375457, 12.004871093091678, 168.98761985999997, 12.004871093091678})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3902917804743265,
    wfWall={0.1417204412109332, 0.2837480899817575, 0.1417204412109332, 0.0212596235610248, 0.0, 0.0212596235610248},
    wfWin={0.43477845406807486, 0.0, 0.43477845406807486, 0.06522154593192517, 0.0, 0.06522154593192517},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000007*522.0382042136924)
