...
model Office
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={1.8160028147130692e-05},
    CExt={511419977.6737872},
    ...
    RExtRem=0.0005773165171965112,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={88.9184568375051, 0.0, 88.9184568375051, 13.338745658990756, 0.0, 13.338745658990756},
    ATransparent={88.9184568375051, 0.0, 88.9184568375051, 13.338745658990756, 0.0, 13.338745658990756},
    AExt={266.7553705125153, 563.2920662, 266.7553705125153, 40.016236976972266, 563.2920662, 40.016236976972266})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1740.1273473789752)
