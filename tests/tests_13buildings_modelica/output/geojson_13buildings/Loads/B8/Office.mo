...
model Office
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={8.947257529716922e-05},
    CExt={116346972.4951068},
    hRad=5.0,
    ...
    RExtRem=0.003180180752666866,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={14.509352025225082, 0.0, 14.509352025225082, 21.464255459546607, 0.0, 21.464255459546607},
    ATransparent={14.509352025225082, 0.0, 14.509352025225082, 21.464255459546607, 0.0, 21.464255459546607},
    AExt={43.528056075675245, 57.12009198, 43.528056075675245, 64.39276637863982, 57.12009198, 64.39276637863982})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.21624310511406683,
    wfWall={0.1263531857926893, 0.15721204267553635, 0.1263531857926893, 0.18691924031250914, 0.0, 0.18691924031250914},
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*330.0818288686301)
