...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.00017894515059433845},
    CExt={58173486.2475534},
    hRad=5.0,
    ...
    RExtRem=0.006360361505333732,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={7.254676012612541, 0.0, 7.254676012612541, 10.732127729773303, 0.0, 10.732127729773303},
    ATransparent={7.254676012612541, 0.0, 7.254676012612541, 10.732127729773303, 0.0, 10.732127729773303},
    AExt={21.764028037837623, 28.56004599, 21.764028037837623, 32.19638318931991, 28.56004599, 32.19638318931991})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*165.04091443431506)
