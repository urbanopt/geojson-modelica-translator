...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.353903444635037,
    hConvWin=2.7,
    gWin=0.7800000000000001,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={0.000298241917657231},
    CExt={34904091.74853203},
    ...
    RExtRem=0.010600602508889553,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={4.352805607567524, 0.0, 4.352805607567524, 6.4392766378639825, 0.0, 6.4392766378639825},
    ATransparent={4.352805607567524, 0.0, 4.352805607567524, 6.4392766378639825, 0.0, 6.4392766378639825},
    AExt={13.058416822702574, 17.136027593999998, 13.058416822702574, 19.317829913591943, 17.136027593999998, 19.317829913591943})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.21624310511406686,
    wfWall={0.1263531857926893, 0.15721204267553635, 0.1263531857926893, 0.18691924031250912, 0.0, 0.18691924031250912},
    wfWin={0.20166662505792843, 0.0, 0.20166662505792843, 0.29833337494207157, 0.0, 0.29833337494207157},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=24.999999999999996*99.02454866058903)
