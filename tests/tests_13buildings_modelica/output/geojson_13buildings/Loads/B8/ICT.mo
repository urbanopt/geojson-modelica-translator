...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0022368143824292317},
    CExt={4653878.899804273},
    ...
    RExtRem=0.07950451881667163,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={0.5803740810090033, 0.0, 0.5803740810090033, 0.8585702183818643, 0.0, 0.8585702183818643},
    ATransparent={0.5803740810090033, 0.0, 0.5803740810090033, 0.8585702183818643, 0.0, 0.8585702183818643},
    AExt={1.74112224302701, 2.2848036792, 1.74112224302701, 2.575710655145593, 2.2848036792, 2.575710655145593})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*13.203273154745204)
