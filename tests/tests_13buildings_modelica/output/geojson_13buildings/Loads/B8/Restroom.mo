...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    VAir=476.82859392,
    hConvExt=2.3539034446350375,
    hConvWin=2.7000000000000006,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={0.0011184071912146158},
    CExt={9307757.799608545},
    ...
    RExtRem=0.039752259408335815,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1.1607481620180067, 0.0, 1.1607481620180067, 1.7171404367637286, 0.0, 1.7171404367637286},
    ATransparent={1.1607481620180067, 0.0, 1.1607481620180067, 1.7171404367637286, 0.0, 1.7171404367637286},
    AExt={3.48224448605402, 4.5696073584, 3.48224448605402, 5.151421310291186, 4.5696073584, 5.151421310291186})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.2162431051140668,
    wfWall={0.1263531857926893, 0.1572120426755363, 0.1263531857926893, 0.18691924031250912, 0.0, 0.18691924031250912},
    wfWin={0.20166662505792848, 0.0, 0.20166662505792848, 0.2983333749420715, 0.0, 0.2983333749420715},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*26.40654630949041)
