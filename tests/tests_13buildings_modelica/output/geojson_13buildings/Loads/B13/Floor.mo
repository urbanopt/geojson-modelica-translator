...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={6.49930484731609e-06},
    CExt={1590252941.774785},
    hRad=5.0,
    ...
    RExtRem=0.00022884697048946375,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={457.372293789985, 0.0, 457.372293789985, 22.87535369831307, 0.0, 22.87535369831307},
    ATransparent={457.372293789985, 0.0, 457.372293789985, 22.87535369831307, 0.0, 22.87535369831307},
    AExt={1372.1168813699549, 844.7510656, 1372.1168813699549, 68.6260610949392, 844.7510656, 68.6260610949392})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*4570.988016129788)
