...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={8.124131059145111e-05},
    CExt={127220235.34198281},
    hRad=5.0,
    AInt=4583.69273856,
    ...
    RExtRem=0.0028605871311182963,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={36.5897835031988, 0.0, 36.5897835031988, 1.8300282958650456, 0.0, 1.8300282958650456},
    ATransparent={36.5897835031988, 0.0, 36.5897835031988, 1.8300282958650456, 0.0, 1.8300282958650456},
    AExt={109.76935050959638, 67.58008524799999, 109.76935050959638, 5.4900848875951365, 67.58008524799999, 5.4900848875951365})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*365.67904129038305)
