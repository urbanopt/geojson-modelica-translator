...
model Office
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.330385788534514,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.029999999999999995,
    nExt=1,
    RExt={3.249652423658045e-06},
    CExt={3180505883.54957},
    hRad=5.0,
    ...
    RExtRem=0.00011442348524473187,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={914.74458757997, 0.0, 914.74458757997, 45.75070739662614, 0.0, 45.75070739662614},
    ATransparent={914.74458757997, 0.0, 914.74458757997, 45.75070739662614, 0.0, 45.75070739662614},
    AExt={2744.2337627399097, 1689.5021312, 2744.2337627399097, 137.2521221898784, 1689.5021312, 137.2521221898784})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.28680493398921975, 0.16741880877688858, 0.28680493398921975, 0.014344472536933531, 0.0, 0.014344472536933531},
    wfWin={0.4761837941133584, 0.0, 0.4761837941133584, 0.023816205886641493, 0.0, 0.023816205886641493},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*9141.976032259576)
