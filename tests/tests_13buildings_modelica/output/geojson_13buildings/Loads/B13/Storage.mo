...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={1.0832174745526823e-05},
    CExt={954151765.0648707},
    hRad=5.0,
    AInt=34377.6955392,
    ...
    RExtRem=0.00038141161748243954,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={274.423376273991, 0.0, 274.423376273991, 13.72521221898784, 0.0, 13.72521221898784},
    ATransparent={274.423376273991, 0.0, 274.423376273991, 13.72521221898784, 0.0, 13.72521221898784},
    AExt={823.2701288219729, 506.85063935999995, 823.2701288219729, 41.17563665696352, 506.85063935999995, 41.17563665696352})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.23028237817080488,
    wfWall={0.2868049339892198, 0.16741880877688856, 0.2868049339892198, 0.014344472536933535, 0.0, 0.014344472536933535},
    wfWin={0.4761837941133585, 0.0, 0.4761837941133585, 0.023816205886641496, 0.0, 0.023816205886641496},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*2742.592809677873)
