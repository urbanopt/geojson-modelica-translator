...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    hConvExt=2.3303857885345134,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.029999999999999992,
    nExt=1,
    RExt={4.0620655295725554e-05},
    CExt={254440470.68396562},
    ...
    RExtRem=0.0014302935655591481,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={73.1795670063976, 0.0, 73.1795670063976, 3.660056591730091, 0.0, 3.660056591730091},
    ATransparent={73.1795670063976, 0.0, 73.1795670063976, 3.660056591730091, 0.0, 3.660056591730091},
    AExt={219.53870101919276, 135.16017049599998, 219.53870101919276, 10.980169775190273, 135.16017049599998, 10.980169775190273})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.23028237817080482,
    wfWall={0.2868049339892198, 0.16741880877688858, 0.2868049339892198, 0.014344472536933533, 0.0, 0.014344472536933533},
    wfWin={0.47618379411335854, 0.0, 0.47618379411335854, 0.023816205886641496, 0.0, 0.023816205886641496},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*731.3580825807661)
