...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    VAir=16702.11591552,
    hConvExt=2.03773934369703,
    hConvWin=2.6999999999999997,
    gWin=0.78,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={1.9664381566172284e-05},
    CExt={468905717.31921315},
    hRad=5.0,
    ...
    RExtRem=0.0006221732413894594,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={89.56334254170783, 0.0, 89.56334254170783, 1.1347760368231072, 0.0, 1.1347760368231072},
    ATransparent={89.56334254170783, 0.0, 89.56334254170783, 1.1347760368231072, 0.0, 1.1347760368231072},
    AExt={268.6900276251235, 533.5398139680002, 268.6900276251235, 3.4043281104693213, 533.5398139680002, 3.4043281104693213})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.39855144006622817,
    wfWall={0.15389788480673447, 0.28975298875326966, 0.15389788480673447, 0.001949900783516639, 0.0, 0.001949900783516639},
    wfWin={0.49374421402225355, 0.0, 0.49374421402225355, 0.006255785977746395, 0.0, 0.006255785977746395},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*1611.268339407186)
