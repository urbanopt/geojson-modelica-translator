...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={3.1463010505875673e-06},
    CExt={2930660733.2450814},
    hRad=5.0,
    AInt=124685.934786,
    ...
    RExtRem=9.954771862231353e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={559.7708908856739, 0.0, 559.7708908856739, 7.09235023014442, 0.0, 7.09235023014442},
    ATransparent={559.7708908856739, 0.0, 559.7708908856739, 7.09235023014442, 0.0, 7.09235023014442},
    AExt={1679.3126726570217, 3334.623837300001, 1679.3126726570217, 21.277050690433256, 3334.623837300001, 21.277050690433256})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*10070.427121294912)
