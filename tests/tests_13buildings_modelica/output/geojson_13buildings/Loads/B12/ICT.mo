...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={3.932876313234457e-05},
    CExt={234452858.65960658},
    hRad=5.0,
    ...
    RExtRem=0.0012443464827789187,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={44.78167127085391, 0.0, 44.78167127085391, 0.5673880184115536, 0.0, 0.5673880184115536},
    ATransparent={44.78167127085391, 0.0, 44.78167127085391, 0.5673880184115536, 0.0, 0.5673880184115536},
    AExt={134.34501381256175, 266.7699069840001, 134.34501381256175, 1.7021640552346606, 266.7699069840001, 1.7021640552346606})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*805.634169703593)
