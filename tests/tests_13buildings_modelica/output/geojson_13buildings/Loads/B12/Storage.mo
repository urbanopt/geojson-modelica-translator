...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={5.243835084312609e-06},
    CExt={1758396439.9470487},
    ...
    RExtRem=0.0001659128643705225,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={335.8625345314043, 0.0, 335.8625345314043, 4.255410138086652, 0.0, 4.255410138086652},
    ATransparent={335.8625345314043, 0.0, 335.8625345314043, 4.255410138086652, 0.0, 4.255410138086652},
    AExt={1007.587603594213, 2000.7743023800006, 1007.587603594213, 12.766230414259953, 2000.7743023800006, 12.766230414259953})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.15389788480673444, 0.2897529887532697, 0.15389788480673444, 0.0019499007835166386, 0.0, 0.0019499007835166386},
    wfWin={0.4937442140222536, 0.0, 0.4937442140222536, 0.006255785977746396, 0.0, 0.006255785977746396},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*6042.256272776947)
