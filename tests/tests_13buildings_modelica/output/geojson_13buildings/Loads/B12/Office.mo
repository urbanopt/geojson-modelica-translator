...
model Office
  ...
  thermalZoneTwoElements(
    ...
    VAir=208776.448944,
    hConvExt=2.0377393436970297,
    hConvWin=2.7,
    gWin=0.78,
    ratioWinConRad=0.030000000000000002,
    nExt=1,
    RExt={1.5731505252937837e-06},
    CExt={5861321466.490163},
    ...
    RExtRem=4.977385931115676e-05,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1119.5417817713478, 0.0, 1119.5417817713478, 14.18470046028884, 0.0, 14.18470046028884},
    ATransparent={1119.5417817713478, 0.0, 1119.5417817713478, 14.18470046028884, 0.0, 14.18470046028884},
    AExt={3358.6253453140434, 6669.247674600002, 3358.6253453140434, 42.55410138086651, 6669.247674600002, 42.55410138086651})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.3985514400662281,
    wfWall={0.15389788480673444, 0.28975298875326966, 0.15389788480673444, 0.0019499007835166384, 0.0, 0.0019499007835166384},
    wfWin={0.4937442140222536, 0.0, 0.4937442140222536, 0.006255785977746395, 0.0, 0.006255785977746395},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=4.999999999999999,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*20140.854242589823)
