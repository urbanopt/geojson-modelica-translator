...
model Storage
  ...
  thermalZoneTwoElements(
    ...
    RExtRem=0.0023999449714304957,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={9.4013095284783, 0.0, 9.4013095284783, 1.390772716953206, 0.0, 1.390772716953206},
    ATransparent={9.4013095284783, 0.0, 9.4013095284783, 1.390772716953206, 0.0, 1.390772716953206},
    AExt={28.203928585434902, 171.36027593999998, 28.203928585434902, 4.172318150859619, 171.36027593999998, 4.172318150859619})
    "Thermal zone"
  ...
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    ...
    wfWall={0.06257625897628176, 0.3604874342954486, 0.06257625897628176, 0.009257152256245035, 0.0, 0.009257152256245035},
    wfWin={0.43556513537774666, 0.0, 0.43556513537774666, 0.06443486462225334, 0.0, 0.06443486462225334},
    withLongwave=true,
    aExt=0.5,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.0*407.473045352589)
