...
model ICT
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.0005961846028884301},
    CExt={13927734.34257431},
    hRad=5.0,
    AInt=119.20714848,
    hConvInt=2.7,
    nInt=1,
    ...
    RExtRem=0.01799958728572872,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={1.25350793713044, 0.0, 1.25350793713044, 0.18543636226042748, 0.0, 0.18543636226042748},
    ATransparent={1.25350793713044, 0.0, 1.25350793713044, 0.18543636226042748, 0.0, 0.18543636226042748},
    AExt={3.7605238113913204, 22.848036792, 3.7605238113913204, 0.5563090867812825, 22.848036792, 0.5563090867812825})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*54.3297393803452)
