...
model Office
  ...
  thermalZoneTwoElements(
    ...
    VAir=5960.357424,
    hConvExt=1.8589123359474207,
    hConvWin=2.6999999999999997,
    gWin=0.7799999999999999,
    ratioWinConRad=0.03,
    nExt=1,
    RExt={2.384738411553716e-05},
    CExt={348193358.56435823},
    hRad=5.0,
    ...
    RExtRem=0.0007199834914291488,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={31.337698428261003, 0.0, 31.337698428261003, 4.6359090565106875, 0.0, 4.6359090565106875},
    ATransparent={31.337698428261003, 0.0, 31.337698428261003, 4.6359090565106875, 0.0, 4.6359090565106875},
    AExt={94.013095284783, 571.2009198, 94.013095284783, 13.907727169532063, 571.2009198, 13.907727169532063})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.49584574323949776,
    wfWall={0.06257625897628175, 0.3604874342954486, 0.06257625897628175, 0.009257152256245033, 0.0, 0.009257152256245033},
    wfWin={0.43556513537774666, 0.0, 0.43556513537774666, 0.06443486462225335, 0.0, 0.06443486462225335},
    withLongwave=true,
    aExt=0.5,
    hConvWallOut=20.0,
    hRad=5.0,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*1358.24348450863)
