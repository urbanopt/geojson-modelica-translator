...
model Floor
  ...
  thermalZoneTwoElements(
    ...
    ratioWinConRad=0.03,
    nExt=1,
    RExt={4.769476823107432e-05},
    CExt={174096679.28217912},
    hRad=5.0,
    AInt=3228.526938,
    hConvInt=2.7,
    nInt=1,
    ...
    RExtRem=0.0014399669828582976,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={15.668849214130502, 0.0, 15.668849214130502, 2.3179545282553438, 0.0, 2.3179545282553438},
    ATransparent={15.668849214130502, 0.0, 15.668849214130502, 2.3179545282553438, 0.0, 2.3179545282553438},
    AExt={47.0065476423915, 285.6004599, 47.0065476423915, 6.953863584766031, 285.6004599, 6.953863584766031})
    "Thermal zone"
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*679.121742254315)
