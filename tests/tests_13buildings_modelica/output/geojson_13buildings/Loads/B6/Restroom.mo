...
model Restroom
  ...
  thermalZoneTwoElements(
    ...
    nExt=1,
    RExt={0.00029809230144421504},
    CExt={27855468.68514862},
    ...
    RExtRem=0.00899979364286436,
    energyDynamics=Modelica.Fluid.Types.Dynamics.FixedInitial,
    extWallRC(thermCapExt(each der_T(fixed=true))),
    intWallRC(thermCapInt(each der_T(fixed=true))),
    nOrientations=6,
    AWin={2.50701587426088, 0.0, 2.50701587426088, 0.37087272452085496, 0.0, 0.37087272452085496},
    ATransparent={2.50701587426088, 0.0, 2.50701587426088, 0.37087272452085496, 0.0, 0.37087272452085496},
    AExt={7.521047622782641, 45.696073584, 7.521047622782641, 1.112618173562565, 45.696073584, 1.112618173562565})
    "Thermal zone"
    annotation (Placement(transformation(extent={{44,-2},{92,34}})));
  Buildings.ThermalZones.ReducedOrder.EquivalentAirTemperature.VDI6007WithWindow eqAirTemp(
    n=6,
    wfGro=0.4958457432394978,
  ...
  Buildings.BoundaryConditions.WeatherData.Bus weaBus "Weather data bus"
    ...
    extent={{-70,-12},{-50,8}})));
  Modelica.Blocks.Sources.Constant alphaWall(k=25.000000000000004*108.6594787606904)
