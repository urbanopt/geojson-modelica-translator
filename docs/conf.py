...
version = f'v{poetry_file["tool"]["poetry"]["version"]}'
# The full version, including alpha/beta/rc tags.
release = f'v{poetry_file["tool"]["poetry"]["version"]}'
...
html_theme_options = {
    ...
    'footerbgcolor': 'black',
    'sidebarwidth': '20%',
    'sidebarbgcolor': BG_COLOR,
    'sidebartextcolor': DEFAULT_TEXT_COLOR,
    'sidebarlinkcolor': GREEN_1,
    'visitedlinkcolor': GREEN_2,
    'headtextcolor': GREEN_2,
    'headbgcolor': BG_COLOR,
    'relbarbgcolor': BG_COLOR,
    'relbartextcolor': DEFAULT_TEXT_COLOR,
    'relbarlinkcolor': GREEN_1,
    'bodyfont': FONTS,
    'headfont': FONTS,
}
...
def remove_module_docstring(app, what, name, obj, options, lines):
    # ignore module docstrings - they're all just licenses
    if what == "module":
        del lines[:]
