...
model CentralHeatingPlant
  ...
  Buildings.Fluid.CHPs.ThermalElectricalFollowing eleFol(
    ...
    waitTime=0)
    annotation (Placement(transformation(extent={{-118,-158},{-98,-138}})));
  Modelica.Blocks.Sources.Constant ElePowDem(
    k=5500)
    annotation (Placement(transformation(extent={{-120,82},{-100,102}})));
  Modelica.Blocks.Sources.Constant TWatOutSet(k=273.15 + 60)
...
equation
  connect(theFolSig.y,eleFol.theFol)
    annotation (Line(points={{-139,58},{-136,58},{-136,-141},{-120,-141}},
                                                                     color={255,0,255}));
  connect(TWatOutSet.y,eleFol.TWatOutSet)
    annotation (Line(points={{-159,-70},{-92,-70},{-92,-143},{-120,-143}},
                                                                  color={0,0,127}));
  connect(ElePowDem.y,eleFol.PEleDem)
    annotation (Line(points={{-99,92},{-92,92},{-92,-145},{-120,-145}},
                                                                  color={0,0,127}));
  connect(eleFol.port_b,port_b)
    annotation (Line(points={{-98,-148},{-92,-148},{-92,-50},{160,-50}},
                                                                  color={0,0,127}));
  ...
  connect(boiStaCon.y_On,boiHotWat.on)
    annotation (Line(points={{-99,70.6},{-72,70.6},{-72,-41},{9,-41}},color={255,0,255}));
  ...
  connect(theFolSig.y, eleFol.avaSig) annotation (Line(points={{-139,58},{-128,
          58},{-128,-139},{-120,-139}}, color={255,0,255}));
  connect(port_a, fan.port_a) annotation (Line(points={{160,50},{-190,50},{-190,
          -121},{-172,-121}}, color={0,127,255}));
  connect(fan.port_b, eleFol.port_a) annotation (Line(points={{-152,-121},{-146,
          -121},{-146,-148},{-118,-148}}, color={0,127,255}));
  connect(eleFol.mWatSet_flow, fan.m_flow_in) annotation (Line(points={{-96,
          -139},{-82,-139},{-82,-94},{-162,-94},{-162,-107.8}}, color={0,0,127}));
  connect(preTem.port, eleFol.TRoo) annotation (Line(points={{-140,-170},{-134,
          -170},{-134,-155},{-118,-155}}, color={191,0,0}));
  annotation (
    Diagram(
      coordinateSystem(
