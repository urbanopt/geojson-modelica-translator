...
model TimeSeriesBuilding
  ...
  replaceable package Medium2=Buildings.Media.Air
    ...
    "Load side medium";
  parameter String filNam="modelica://Mainz_Kastel_DES/Loads/Resources/Data/B1/modelica.mos"
...
equation
  ...
  connect(ports_aHeaWat[1],disFloHea.port_a)
    annotation (Line(points={{-300,-60},{-90,-60},{-90,-60},{120,-60}},color={0,127,255}));
  connect(ports_bHeaWat[1],disFloHea.port_b)
    annotation (Line(points={{300,-60},{220,-60},{220,-60},{140,-60}},color={0,127,255}));
