...
package MediumW = Buildings.Media.Water;
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TBuiRet(redeclare final package Medium =
    ...
    "District-side (primary) supply temperature sensor" annotation (Placement(
        ...
        rotation=0,
        origin={58,-76})));
  Buildings.Fluid.Sensors.TemperatureTwoPort TBuiSup(redeclare final package Medium =
        MediumW, final m_flow_nominal=mBui_flow_nominal)
    "District-side (primary) supply temperature sensor" annotation (Placement(
        transformation(
        extent={{10,-10},{-10,10}},
