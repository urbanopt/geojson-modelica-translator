...
equation
  ...
  connect(boi.port_b,val.port_a)
    annotation (Line(points={{0,0},{36,0}},color={0,127,255}));
  connect(boi.T,TBoiLvg)
    annotation (Line(points={{1,8},{20,8},{20,40},{110,40}},color={0,0,127}));
  ...
  connect(pro.y,boi.y)
    annotation (Line(points={{-15,28},{-12,28},{-12,8},{-22,8}},color={0,0,127}));
  connect(PI_TBoiLvg.y,pro[1].u2)
    annotation (Line(points={{-55,-28},{-44,-28},{-44,22},{-38,22}},color={0,0,127}));
  ...
  connect(senTDisSup.T,PI_TBoiLvg.u_m)
    annotation (Line(points={{76,11},{76,18},{62,18},{62,-74},{-66,-74},{-66,-40}},color={0,0,127}));
  connect(THeaWatSet,PI_TBoiLvg.u_s)
    annotation (Line(points={{-110,-60},{-92,-60},{-92,-28},{-78,-28}},color={0,0,127}));
