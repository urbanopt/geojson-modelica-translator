...
Buildings.Controls.OBC.CDL.Interfaces.BooleanInput ON[numPum]
  "Boiler on/off signal." annotation (Placement(transformation(extent={{-120,76},
          {-100,96}}), iconTransformation(extent={{-120,56},{-100,76}})));
Buildings.Controls.OBC.CDL.Interfaces.RealInput masFloPum(
  final unit="kg/s") "Total mass flowrate of heating water pumps"
...
Buildings.Controls.OBC.CDL.Interfaces.RealInput dpMea(
  final unit="Pa") "Measured pressure difference"
...
Modelica.Blocks.Sources.RealExpression norDecMasFlo(y=meaFloByPas/(if ON[
...
connect(conPID.y, pumSpe[1].u2) annotation (Line(points={{-39,0},{-20,0},{-20,
        -26},{26,-26},{26,-6},{32,-6}}, color={0,0,127}));
