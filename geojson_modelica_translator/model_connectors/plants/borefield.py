    ...
    def to_modelica(self, scaffold):
        ...
        if Path(template_data["gfunction"]["input_path"]).expanduser().is_absolute():
            ...
            try:
                ...
                raise SystemExit(f'When using a relative path to your ghe_dir, your path \'{
                                 template_data["gfunction"]["input_path"]}\' must be relative to the dir your sys-param file is in.')
