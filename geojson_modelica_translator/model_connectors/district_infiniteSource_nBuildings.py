...
class DistrictInfiniteSourceNBuildingsTemplate(model_connector_base):
    ...
    def to_modelica(self, scaffold):
        ...
        try:
            for building in self.buildings:
                ...
                district_new = district_template.render(
                    project_name=scaffold.project_name,
                    model_name=f"B{building['building_id']}",
                ...
                with open(os.path.join(os.path.join(b_modelica_path.files_dir, "District_nBuildings_Infinite.mo")),
                          "w") as f:
                    f.write(district_new)
    ...
    def post_process(self, scaffold, building_names):
        ...
        for b in building_names:
            ...
            new_package = PackageParser.new_from_template(
                b_modelica_path, b,
                ["BuildingRCZ6", "CoolingIndirect", "District_nBuildings_Infinite"],
