...
def sys_param(sys_param_filename, scenario_dir, feature_file):
    """GMT CLI."""
    sys_param_template_path = Path(__file__).parent.parent / 'geojson_modelica_translator' / 'system_parameters' / 'time_series_template.json'
