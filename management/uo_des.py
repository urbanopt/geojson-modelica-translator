...
@cli.command()
@click.option('--sys_param_filename', default="test_sys_param.json", help='Name of systems parameters file to create. Include ".json" in your name')
@click.option("--scenario_dir", help="Path to an urbanopt scenario, probably in the 'run' folder of your UO SDK project directory")
@click.option("--sys_param_template", default=Path.cwd() / "tests" / "geojson" / "data" / "time_series_template.json", help="Path to the template sys_param.json file")
